...
public interface Player {
    ...
    @Deprecated
    public static abstract class DefaultEventListener implements Player$EventListener {
    ...
    void addListener(Player$EventListener player$EventListener);
    ...
    void removeListener(Player$EventListener player$EventListener);
