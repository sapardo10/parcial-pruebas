...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    public static final class Builder {
        ...
        public DefaultBandwidthMeter build() {
            ...
            if (handler != null) {
                BandwidthMeter$EventListener bandwidthMeter$EventListener = this.eventListener;
                if (bandwidthMeter$EventListener != null) {
                    bandwidthMeter.addEventListener(handler, bandwidthMeter$EventListener);
    ...
    private void notifyBandwidthSample(int elapsedMs, long bytes, long bitrate) {
        this.eventDispatcher.dispatch(new -$$Lambda$DefaultBandwidthMeter$0dWpVoCfeEm8PONlag-OKGMu96M(elapsedMs, bytes, bitrate));
    }
