...
public final class SpliceScheduleCommand extends SpliceCommand {
    public static final Creator<SpliceScheduleCommand> CREATOR = new C06051();
    public final List<Event> events;

    /* renamed from: com.google.android.exoplayer2.metadata.scte35.SpliceScheduleCommand$1 */
    static class C06051 implements Creator<SpliceScheduleCommand> {
        C06051() {
        }
    ...
    public static final class Event {
        ...
        private static Event parseFromSection(ParsableByteArray sectionData) {
            ...
            long utcSpliceTime2 = C0555C.TIME_UNSET;
            ...
            if (spliceEventCancelIndicator) {
                ...
                utcSpliceTime = C0555C.TIME_UNSET;
                ...
                if (programSpliceFlag2) {
                    ...
                    int componentCount;
                    int componentCount2 = sectionData.readUnsignedByte();
                ...
                if (durationFlag) {
                    ...
                    autoReturn2 = (128 & outOfNetworkIndicator2) != 0;
                    breakDurationUs2 = (1000 * (((1 & outOfNetworkIndicator2) << 32) | sectionData.readUnsignedInt())) / 90;
                }
