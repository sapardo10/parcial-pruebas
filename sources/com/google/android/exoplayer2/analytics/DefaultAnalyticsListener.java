...
public abstract class DefaultAnalyticsListener implements AnalyticsListener {
    ...
    public /* synthetic */ void onDownstreamFormatChanged(EventTime eventTime, MediaSourceEventListener$MediaLoadData mediaSourceEventListener$MediaLoadData) {
        -CC.$default$onDownstreamFormatChanged(this, eventTime, mediaSourceEventListener$MediaLoadData);
    }
    ...
    public /* synthetic */ void onDrmSessionManagerError(EventTime eventTime, Exception exception) {
        -CC.$default$onDrmSessionManagerError(this, eventTime, exception);
    }
    ...
    public /* synthetic */ void onLoadCanceled(EventTime eventTime, MediaSourceEventListener$LoadEventInfo mediaSourceEventListener$LoadEventInfo, MediaSourceEventListener$MediaLoadData mediaSourceEventListener$MediaLoadData) {
        -CC.$default$onLoadCanceled(this, eventTime, mediaSourceEventListener$LoadEventInfo, mediaSourceEventListener$MediaLoadData);
    }

    public /* synthetic */ void onLoadCompleted(EventTime eventTime, MediaSourceEventListener$LoadEventInfo mediaSourceEventListener$LoadEventInfo, MediaSourceEventListener$MediaLoadData mediaSourceEventListener$MediaLoadData) {
        -CC.$default$onLoadCompleted(this, eventTime, mediaSourceEventListener$LoadEventInfo, mediaSourceEventListener$MediaLoadData);
    }

    public /* synthetic */ void onLoadError(EventTime eventTime, MediaSourceEventListener$LoadEventInfo mediaSourceEventListener$LoadEventInfo, MediaSourceEventListener$MediaLoadData mediaSourceEventListener$MediaLoadData, IOException iOException, boolean z) {
        -CC.$default$onLoadError(this, eventTime, mediaSourceEventListener$LoadEventInfo, mediaSourceEventListener$MediaLoadData, iOException, z);
    }

    public /* synthetic */ void onLoadStarted(EventTime eventTime, MediaSourceEventListener$LoadEventInfo mediaSourceEventListener$LoadEventInfo, MediaSourceEventListener$MediaLoadData mediaSourceEventListener$MediaLoadData) {
        -CC.$default$onLoadStarted(this, eventTime, mediaSourceEventListener$LoadEventInfo, mediaSourceEventListener$MediaLoadData);
    }
    ...
    public /* synthetic */ void onUpstreamDiscarded(EventTime eventTime, MediaSourceEventListener$MediaLoadData mediaSourceEventListener$MediaLoadData) {
        -CC.$default$onUpstreamDiscarded(this, eventTime, mediaSourceEventListener$MediaLoadData);
    }
