...
public final /* synthetic */ class C0612x9d2b2b7d implements Runnable {
    ...
    public final void run() {
        this.f$1.onLoadCanceled(this.f$0.windowIndex, this.f$0.mediaPeriodId, this.f$2, this.f$3);
    }
}
