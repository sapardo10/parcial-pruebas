...
public class SsManifestParser implements Parser<SsManifest> {
    ...
    private static abstract class ElementParser {
        ...
        protected final Object getNormalizedAttribute(String key) {
            ...
            return elementParser == null ? null : elementParser.getNormalizedAttribute(key);
        }
    ...
    private static class ProtectionParser extends ElementParser {
        ...
        public Object build() {
            UUID uuid = this.uuid;
            return new ProtectionElement(uuid, PsshAtomUtil.buildPsshAtom(uuid, this.initData));
        }
    ...
    private static class QualityLevelParser extends ElementParser {
        ...
        public void parseStartTag(XmlPullParser parser) throws ParserException {
            ...
            if (type == 2) {
                r0.format = Format.createVideoContainerFormat(id, name, MimeTypes.VIDEO_MP4, sampleMimeType, null, bitrate, parseRequiredInt(xmlPullParser, KEY_MAX_WIDTH), parseRequiredInt(xmlPullParser, KEY_MAX_HEIGHT), -1.0f, buildCodecSpecificData(xmlPullParser.getAttributeValue(null, KEY_CODEC_PRIVATE_DATA)), 0);
            } else if (type == 1) {
                ...
                r0.format = Format.createAudioContainerFormat(id, name, MimeTypes.AUDIO_MP4, sampleMimeType2, null, bitrate, channels, samplingRate, codecSpecificData, 0, (String) getNormalizedAttribute(KEY_LANGUAGE));
            } else if (type == 3) {
                r0.format = Format.createTextContainerFormat(id, name, MimeTypes.APPLICATION_MP4, sampleMimeType, null, bitrate, 0, (String) getNormalizedAttribute(KEY_LANGUAGE));
            } else {
                r0.format = Format.createContainerFormat(id, name, MimeTypes.APPLICATION_MP4, sampleMimeType, null, bitrate, 0, null);
            }
        }
        ...
        private static String fourCCToMimeType(String fourCC) {
            if (!fourCC.equalsIgnoreCase("H264") && !fourCC.equalsIgnoreCase("X264")) {
                if (!fourCC.equalsIgnoreCase("AVC1")) {
                    if (!fourCC.equalsIgnoreCase("DAVC")) {
                        if (!fourCC.equalsIgnoreCase("AAC") && !fourCC.equalsIgnoreCase("AACL")) {
                            if (!fourCC.equalsIgnoreCase("AACH")) {
                                if (!fourCC.equalsIgnoreCase("AACP")) {
                                    if (!fourCC.equalsIgnoreCase("TTML")) {
                                        if (!fourCC.equalsIgnoreCase("DFXP")) {
                                            if (!fourCC.equalsIgnoreCase("ac-3")) {
                                                if (!fourCC.equalsIgnoreCase("dac3")) {
                                                    if (!fourCC.equalsIgnoreCase("ec-3")) {
                                                        if (!fourCC.equalsIgnoreCase("dec3")) {
                                                            if (fourCC.equalsIgnoreCase("dtsc")) {
                                                                return MimeTypes.AUDIO_DTS;
                                                            }
                                                            if (!fourCC.equalsIgnoreCase("dtsh")) {
                                                                if (!fourCC.equalsIgnoreCase("dtsl")) {
    ...
    private static class SmoothStreamingMediaParser extends ElementParser {
        ...
        public Object build() {
            ...
            if (protectionElement != null) {
                ...
                SchemeData schemeData = new SchemeData(protectionElement.uuid, MimeTypes.VIDEO_MP4, this.protectionElement.data);
                int i = 0;
                schemeDataArr[0] = schemeData;
                DrmInitData drmInitData = new DrmInitData(schemeDataArr);
                int length = streamElementArray.length;
                while (i < length) {
                    StreamElement streamElement = streamElementArray[i];
                    ...
                    for (int i2 = 0; i2 < formats.length; i2++) {
                        formats[i2] = formats[i2].copyWithDrmInitData(drmInitData);
                    }
                    i++;
                }
            }
    ...
    private static class StreamIndexParser extends ElementParser {
        ...
        private void parseStreamFragmentStartTag(XmlPullParser parser) throws ParserException {
            ...
            if (repeatCount > 1) {
                if (this.lastChunkDuration == C0555C.TIME_UNSET) {
