...
public final class H265Reader implements ElementaryStreamReader {
    ...
    private static Format parseMediaFormat(String formatId, NalUnitTargetBuffer vps, NalUnitTargetBuffer sps, NalUnitTargetBuffer pps) {
        ...
        for (confWinLeftOffset = bitArray.readBit() ? 0 : maxSubLayersMinus1; confWinLeftOffset <= maxSubLayersMinus1; confWinLeftOffset++) {
            bitArray.readUnsignedExpGolombCodedInt();
            bitArray.readUnsignedExpGolombCodedInt();
            bitArray.readUnsignedExpGolombCodedInt();
        }
        ...
        if (bitArray.readBit()) {
            for (confWinRightOffset = 0; confWinRightOffset < bitArray.readUnsignedExpGolombCodedInt(); confWinRightOffset++) {
