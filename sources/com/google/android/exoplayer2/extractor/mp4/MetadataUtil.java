...
final class MetadataUtil {
    ...
    public static Entry parseIlstElement(ParsableByteArray ilst) {
        ...
        int shortType = ViewCompat.MEASURED_SIZE_MASK & type;
                ...
                if (shortType != SHORT_TYPE_COMPOSER_1) {
                    if (shortType != SHORT_TYPE_COMPOSER_2) {
                        if (shortType == SHORT_TYPE_YEAR) {
                            ...
                            Log.m4d(str2, stringBuilder2.toString());
                            ilst.setPosition(endPosition);
                            return null;
                        }
                    }
    ...
    private static CommentFrame parseCommentAttribute(int type, ParsableByteArray data) {
        ...
        stringBuilder.append(Atom.getAtomTypeString(type));
        Log.m10w(value, stringBuilder.toString());
        return null;
    }
    ...
    private static TextInformationFrame parseStandardGenreAttribute(ParsableByteArray data) {
        ...
        if (genreCode > 0) {
            ...
            if (genreCode <= strArr.length) {
                ...
                Log.m10w(TAG, "Failed to parse standard genre code");
                return null;
            }
        }
        genreString = null;
    ...
    private static ApicFrame parseCoverArt(ParsableByteArray data) {
        ...
        Log.m10w(TAG, "Failed to parse cover art attribute");
        return null;
    }
    ...
    private static int parseUint8AttributeValue(ParsableByteArray data) {
        ...
        Log.m10w(TAG, "Failed to parse uint8 attribute value");
        return -1;
    }
}
