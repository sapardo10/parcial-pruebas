...
public class MDTintHelper {
    public static void setTint(@NonNull RadioButton radioButton, @ColorInt int color) {
        ...
        ColorStateList sl = new ColorStateList(new int[][]{new int[]{16842910, -16842912}, new int[]{16842910, 16842912}, new int[]{-16842910, -16842912}, new int[]{-16842910, 16842912}}, new int[]{DialogUtils.resolveColor(radioButton.getContext(), C0498R.attr.colorControlNormal), color, disabledColor, disabledColor});
        if (VERSION.SDK_INT >= 21) {
            radioButton.setButtonTintList(sl);
            return;
        }
        Drawable d = DrawableCompat.wrap(ContextCompat.getDrawable(radioButton.getContext(), C0498R.drawable.abc_btn_radio_material));
    ...
    private static ColorStateList createEditTextColorStateList(@NonNull Context context, @ColorInt int color) {
        ...
        colors[0] = DialogUtils.resolveColor(context, C0498R.attr.colorControlNormal);
        int i = 0 + 1;
        states[i] = new int[]{-16842919, -16842908};
        colors[i] = DialogUtils.resolveColor(context, C0498R.attr.colorControlNormal);
        i++;
        states[i] = new int[0];
        colors[i] = color;
    ...
    public static void setTint(@NonNull CheckBox box, @ColorInt int color) {
        ...
        ColorStateList sl = new ColorStateList(new int[][]{new int[]{16842910, -16842912}, new int[]{16842910, 16842912}, new int[]{-16842910, -16842912}, new int[]{-16842910, 16842912}}, new int[]{DialogUtils.resolveColor(box.getContext(), C0498R.attr.colorControlNormal), color, disabledColor, disabledColor});
        if (VERSION.SDK_INT >= 21) {
            box.setButtonTintList(sl);
            return;
        }
        Drawable drawable = DrawableCompat.wrap(ContextCompat.getDrawable(box.getContext(), C0498R.drawable.abc_btn_check_material));
