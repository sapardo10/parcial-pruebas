...
public class CircleView extends FrameLayout {
    ...
    private static int translucentColor(int color) {
        return Color.argb(Math.round(((float) Color.alpha(color)) * 1060320051), Color.red(color), Color.green(color), Color.blue(color));
    }
    ...
    public void showHint(int color) {
        ...
        Toast cheatSheet = Toast.makeText(context, String.format("#%06X", new Object[]{Integer.valueOf(ViewCompat.MEASURED_SIZE_MASK & color)}), 0);
