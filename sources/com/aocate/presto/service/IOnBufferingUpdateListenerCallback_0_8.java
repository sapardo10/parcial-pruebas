...
public interface IOnBufferingUpdateListenerCallback_0_8 extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IOnBufferingUpdateListenerCallback_0_8 {
        ...
        public static IOnBufferingUpdateListenerCallback_0_8 asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof IOnBufferingUpdateListenerCallback_0_8)) {
                return new Proxy(obj);
            }
            return (IOnBufferingUpdateListenerCallback_0_8) iin;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            if (code == 1) {
                ...
                onBufferingUpdate(data.readInt());
