...
public class RequestOptions implements Cloneable {
    ...
    private RequestOptions scaleOnlyTransform(@NonNull DownsampleStrategy strategy, @NonNull Transformation<Bitmap> transformation, boolean isTransformationRequired) {
        RequestOptions result = isTransformationRequired ? transform(strategy, (Transformation) transformation) : optionalTransform(strategy, (Transformation) transformation);
    ...
    public RequestOptions transforms(@NonNull Transformation<Bitmap>... transformations) {
        return transform(new MultiTransformation((Transformation[]) transformations), true);
    }
    ...
    private RequestOptions transform(@NonNull Transformation<Bitmap> transformation, boolean isRequired) {
        if (this.isAutoCloneEnabled) {
            return clone().transform((Transformation) transformation, isRequired);
        }
    ...
    public boolean equals(Object o) {
        ...
        if (Float.compare(other.sizeMultiplier, this.sizeMultiplier) == 0 && this.errorId == other.errorId) {
            if (Util.bothNullOrEqual(this.errorPlaceholder, other.errorPlaceholder) && this.placeholderId == other.placeholderId) {
                if (Util.bothNullOrEqual(this.placeholderDrawable, other.placeholderDrawable) && this.fallbackId == other.fallbackId) {
                    if (Util.bothNullOrEqual(this.fallbackDrawable, other.fallbackDrawable) && this.isCacheable == other.isCacheable && this.overrideHeight == other.overrideHeight && this.overrideWidth == other.overrideWidth && this.isTransformationRequired == other.isTransformationRequired && this.isTransformationAllowed == other.isTransformationAllowed && this.useUnlimitedSourceGeneratorsPool == other.useUnlimitedSourceGeneratorsPool && this.onlyRetrieveFromCache == other.onlyRetrieveFromCache) {
                        if (this.diskCacheStrategy.equals(other.diskCacheStrategy) && this.priority == other.priority) {
                            if (this.options.equals(other.options)) {
                                if (this.transformations.equals(other.transformations)) {
                                    if (this.resourceClass.equals(other.resourceClass)) {
                                        if (Util.bothNullOrEqual(this.signature, other.signature)) {
                                            if (Util.bothNullOrEqual(this.theme, other.theme)) {
                                                z = true;
                                                return z;
                                            }
                                        }
