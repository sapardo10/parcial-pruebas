...
public class Entities {
    ...
    public enum EscapeMode {
        ...
        String nameForCodepoint(int codepoint) {
            ...
            String str = (index >= strArr.length + -1 || this.codeKeys[index + 1] != codepoint) ? this.nameVals[index] : strArr[index + 1];
            return str;
        }
    ...
    private static void load(EscapeMode e, String pointsData, int size) {
        ...
        while (true) {
            ...
            int index = Integer.parseInt(reader.consumeTo((char) Typography.amp), 36);
            reader.advance();
            e.nameKeys[i2] = name;
            e.codeVals[i2] = cp1;
