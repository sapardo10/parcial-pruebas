...
public class AnnotationUtils {
    private static final ToStringStyle TO_STRING_STYLE = new C12111();

    /* renamed from: org.apache.commons.lang3.AnnotationUtils$1 */
    static class C12111 extends ToStringStyle {
    ...
    public static boolean isValidAnnotationMemberType(Class<?> type) {
        ...
        if (!(type.isPrimitive() || type.isEnum() || type.isAnnotation() || String.class.equals(type))) {
