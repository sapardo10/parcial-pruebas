...
public enum JavaVersion {
    ...
    static JavaVersion get(String nom) {
        ...
        double toFloatVersion = (double) toFloatVersion(nom);
        Double.isNaN(toFloatVersion);
        if (toFloatVersion - 1.0d < 1.0d) {
    ...
    private static float toFloatVersion(String value) {
        ...
        stringBuilder.append(toParse[0]);
        stringBuilder.append('.');
        stringBuilder.append(toParse[1]);
        return NumberUtils.toFloat(stringBuilder.toString(), -1.0f);
    }
}
