...
public class EnumUtils {
    ...
    private static <E extends Enum<E>> Class<E> checkBitVectorable(Class<E> enumClass) {
        Validate.isTrue(((Enum[]) asEnum(enumClass).getEnumConstants()).length <= 64, CANNOT_STORE_S_S_VALUES_IN_S_BITS, Integer.valueOf(((Enum[]) asEnum(enumClass).getEnumConstants()).length), enumClass.getSimpleName(), Integer.valueOf(64));
        return enumClass;
    }
