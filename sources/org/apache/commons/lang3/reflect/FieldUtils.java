...
public class FieldUtils {
    ...
    public static Object readField(Object target, String fieldName, boolean forceAccess) throws IllegalAccessException {
        ...
        Validate.isTrue(field != null, "Cannot locate field %s on %s", fieldName, target.getClass());
        return readField(field, target, false);
    }
    ...
    public static Object readDeclaredField(Object target, String fieldName, boolean forceAccess) throws IllegalAccessException {
        ...
        Validate.isTrue(field != null, "Cannot locate declared field %s.%s", target.getClass(), fieldName);
        return readField(field, target, false);
    }
    ...
    public static void writeField(Object target, String fieldName, Object value, boolean forceAccess) throws IllegalAccessException {
        Validate.isTrue(target != null, "target object must not be null", new Object[0]);
        Field field = getField(target.getClass(), fieldName, forceAccess);
        Validate.isTrue(field != null, "Cannot locate declared field %s.%s", target.getClass().getName(), fieldName);
        writeField(field, target, value, false);
    }
