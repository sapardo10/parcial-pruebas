...
public class EntityArrays {
    ...
    public static final Map<CharSequence, CharSequence> APOS_UNESCAPE = Collections.unmodifiableMap(invert(APOS_ESCAPE));
    public static final Map<CharSequence, CharSequence> BASIC_ESCAPE;
    public static final Map<CharSequence, CharSequence> BASIC_UNESCAPE = Collections.unmodifiableMap(invert(BASIC_ESCAPE));
    public static final Map<CharSequence, CharSequence> HTML40_EXTENDED_ESCAPE;
    public static final Map<CharSequence, CharSequence> HTML40_EXTENDED_UNESCAPE = Collections.unmodifiableMap(invert(HTML40_EXTENDED_ESCAPE));
    public static final Map<CharSequence, CharSequence> ISO8859_1_ESCAPE;
    public static final Map<CharSequence, CharSequence> ISO8859_1_UNESCAPE = Collections.unmodifiableMap(invert(ISO8859_1_ESCAPE));
    public static final Map<CharSequence, CharSequence> JAVA_CTRL_CHARS_ESCAPE;
    public static final Map<CharSequence, CharSequence> JAVA_CTRL_CHARS_UNESCAPE = Collections.unmodifiableMap(invert(JAVA_CTRL_CHARS_ESCAPE));
    ...
    static {
        ...
        initialMap.put("\t", "\\t");
        initialMap.put("\f", "\\f");
        initialMap.put(StringUtils.CR, "\\r");
    ...
    public static Map<CharSequence, CharSequence> invert(Map<CharSequence, CharSequence> map) {
        ...
        for (Entry<CharSequence, CharSequence> pair : map.entrySet()) {
