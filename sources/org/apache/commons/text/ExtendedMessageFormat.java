...
*/
    ...
    L_0x003e:
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.apache.commons.text.ExtendedMessageFormat.appendQuotedString(java.lang.String, java.text.ParsePosition, java.lang.StringBuilder):java.lang.StringBuilder");
    }

    private java.lang.String parseFormatDescription(java.lang.String r7, java.text.ParsePosition r8) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:19:0x0060 in {9, 13, 14, 15, 16, 18} preds:[]
	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.computeDominators(BlockProcessor.java:129)
	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.processBlocksTree(BlockProcessor.java:48)
	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.visit(BlockProcessor.java:38)
	at jadx.core.dex.visitors.DepthTraversal.visit(DepthTraversal.java:31)
...
*/
    ...
    L_0x0049:
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.apache.commons.text.ExtendedMessageFormat.parseFormatDescription(java.lang.String, java.text.ParsePosition):java.lang.String");
    }
...
*/
        ...
        while (pos.getIndex() < pattern.length()) {
            ...
            if (c2 != QUOTE) {
                if (c2 == START_FE) {
                    ...
                    } else if (foundDescriptions.size() != fmtCount) {
                        throw new IllegalArgumentException("The validated expression is false");
    ...
    public boolean equals(Object obj) {
        ...
        if (Objects.equals(this.toPattern, rhs.toPattern) && super.equals(obj)) {
    ...
    private void seekNonWs(String pattern, ParsePosition pos) {
        ...
        while (true) {
            int len = StringMatcherFactory.INSTANCE.splitMatcher().isMatch(buffer, pos.getIndex(), 0, buffer.length);
