...
public class ArchTaskExecutor extends TaskExecutor {
    @NonNull
    private static final Executor sIOThreadExecutor = new C00242();
    private static volatile ArchTaskExecutor sInstance;
    @NonNull
    private static final Executor sMainThreadExecutor = new C00231();
    @NonNull
    ...
    static class C00231 implements Executor {
        C00231() {
        }
    ...
    static class C00242 implements Executor {
        C00242() {
        }
