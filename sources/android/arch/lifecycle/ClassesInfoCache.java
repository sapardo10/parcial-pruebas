...
class ClassesInfoCache {
    ...
    static class CallbackInfo {
        ...
        CallbackInfo(Map<MethodReference, Lifecycle$Event> handlerToEvent) {
            ...
            for (Entry<MethodReference, Lifecycle$Event> entry : handlerToEvent.entrySet()) {
    ...
    private void verifyAndPutHandler(Map<MethodReference, Lifecycle$Event> handlers, MethodReference newHandler, Lifecycle$Event newEvent, Class klass) {
        Lifecycle$Event event = (Lifecycle$Event) handlers.get(newHandler);
        if (event != null) {
            if (newEvent != event) {
    ...
    private CallbackInfo createInfo(Class klass, @Nullable Method[] declaredMethods) {
        ...
        for (Class intrfc : klass.getInterfaces()) {
            for (Entry<MethodReference, Lifecycle$Event> entry : getInfo(intrfc).mHandlerToEvent.entrySet()) {
