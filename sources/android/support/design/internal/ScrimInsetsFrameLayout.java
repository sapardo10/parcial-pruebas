...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    class C08071 implements OnApplyWindowInsetsListener {
        C08071() {
        }
    ...
    public ScrimInsetsFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0035R.styleable.ScrimInsetsFrameLayout, defStyleAttr, C0035R.style.Widget_Design_ScrimInsetsFrameLayout);
        this.mInsetForeground = a.getDrawable(C0035R.styleable.ScrimInsetsFrameLayout_insetForeground);
        a.recycle();
        setWillNotDraw(true);
        ViewCompat.setOnApplyWindowInsetsListener(this, new C08071());
    }
