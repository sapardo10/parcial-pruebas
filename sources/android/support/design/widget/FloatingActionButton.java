...
public class FloatingActionButton extends VisibilityAwareImageButton {
    ...
    public static class Behavior extends android.support.design.widget.CoordinatorLayout.Behavior<FloatingActionButton> {
        ...
        public Behavior(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0035R.styleable.FloatingActionButton_Behavior_Layout);
            this.mAutoHideEnabled = a.getBoolean(C0035R.styleable.FloatingActionButton_Behavior_Layout_behavior_autoHide, true);
            a.recycle();
        }
    ...
    private class ShadowDelegateImpl implements ShadowViewDelegate {
        ...
        public void setShadowPadding(int left, int top, int right, int bottom) {
            ...
            floatingActionButton.setPadding(floatingActionButton.mImagePadding + left, FloatingActionButton.this.mImagePadding + top, FloatingActionButton.this.mImagePadding + right, FloatingActionButton.this.mImagePadding + bottom);
        }
    ...
    public FloatingActionButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0035R.styleable.FloatingActionButton, defStyleAttr, C0035R.style.Widget_Design_FloatingActionButton);
        this.mBackgroundTint = a.getColorStateList(C0035R.styleable.FloatingActionButton_backgroundTint);
        this.mBackgroundTintMode = ViewUtils.parseTintMode(a.getInt(C0035R.styleable.FloatingActionButton_backgroundTintMode, -1), null);
        this.mRippleColor = a.getColor(C0035R.styleable.FloatingActionButton_rippleColor, 0);
        this.mSize = a.getInt(C0035R.styleable.FloatingActionButton_fabSize, -1);
        this.mCustomSize = a.getDimensionPixelSize(C0035R.styleable.FloatingActionButton_fabCustomSize, 0);
        this.mBorderWidth = a.getDimensionPixelSize(C0035R.styleable.FloatingActionButton_borderWidth, 0);
        float elevation = a.getDimension(C0035R.styleable.FloatingActionButton_elevation, 0.0f);
        float pressedTranslationZ = a.getDimension(C0035R.styleable.FloatingActionButton_pressedTranslationZ, 0.0f);
        this.mCompatPadding = a.getBoolean(C0035R.styleable.FloatingActionButton_useCompatPadding, false);
        a.recycle();
    ...
    private int getSizeDimension(int size) {
        ...
        if (size == -1) {
            ...
            return res.getDimensionPixelSize(C0035R.dimen.design_fab_size_normal);
        } else {
            return res.getDimensionPixelSize(C0035R.dimen.design_fab_size_mini);
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        if (ev.getAction() == 0) {
            if (getContentRect(this.mTouchArea)) {
                if (!this.mTouchArea.contains((int) ev.getX(), (int) ev.getY())) {
                    return false;
                }
            }
        }
