...
public class TextInputLayout extends LinearLayout implements WithHint {
    ...
    class C00651 implements TextWatcher {
        ...
        public void afterTextChanged(Editable s) {
            ...
            textInputLayout.updateLabelState(textInputLayout.mRestoringSavedState ^ 1);
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C00701();
        CharSequence error;
        boolean isPasswordToggledVisible;

        /* renamed from: android.support.design.widget.TextInputLayout$SavedState$1 */
        static class C00701 implements ClassLoaderCreator<SavedState> {
            C00701() {
            }
    ...
    public TextInputLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0035R.styleable.TextInputLayout, defStyleAttr, C0035R.style.Widget_Design_TextInputLayout);
        this.mHintEnabled = a.getBoolean(C0035R.styleable.TextInputLayout_hintEnabled, true);
        setHint(a.getText(C0035R.styleable.TextInputLayout_android_hint));
        this.mHintAnimationEnabled = a.getBoolean(C0035R.styleable.TextInputLayout_hintAnimationEnabled, true);
        if (a.hasValue(C0035R.styleable.TextInputLayout_android_textColorHint)) {
            ColorStateList colorStateList = a.getColorStateList(C0035R.styleable.TextInputLayout_android_textColorHint);
            this.mFocusedTextColor = colorStateList;
            this.mDefaultTextColor = colorStateList;
        }
        if (a.getResourceId(C0035R.styleable.TextInputLayout_hintTextAppearance, -1) != -1) {
            setHintTextAppearance(a.getResourceId(C0035R.styleable.TextInputLayout_hintTextAppearance, 0));
        }
        this.mErrorTextAppearance = a.getResourceId(C0035R.styleable.TextInputLayout_errorTextAppearance, 0);
        boolean errorEnabled = a.getBoolean(C0035R.styleable.TextInputLayout_errorEnabled, false);
        boolean counterEnabled = a.getBoolean(C0035R.styleable.TextInputLayout_counterEnabled, false);
        setCounterMaxLength(a.getInt(C0035R.styleable.TextInputLayout_counterMaxLength, -1));
        this.mCounterTextAppearance = a.getResourceId(C0035R.styleable.TextInputLayout_counterTextAppearance, 0);
        this.mCounterOverflowTextAppearance = a.getResourceId(C0035R.styleable.TextInputLayout_counterOverflowTextAppearance, 0);
        this.mPasswordToggleEnabled = a.getBoolean(C0035R.styleable.TextInputLayout_passwordToggleEnabled, false);
        this.mPasswordToggleDrawable = a.getDrawable(C0035R.styleable.TextInputLayout_passwordToggleDrawable);
        this.mPasswordToggleContentDesc = a.getText(C0035R.styleable.TextInputLayout_passwordToggleContentDescription);
        if (a.hasValue(C0035R.styleable.TextInputLayout_passwordToggleTint)) {
            this.mHasPasswordToggleTintList = true;
            this.mPasswordToggleTintList = a.getColorStateList(C0035R.styleable.TextInputLayout_passwordToggleTint);
        }
        if (a.hasValue(C0035R.styleable.TextInputLayout_passwordToggleTintMode)) {
            this.mHasPasswordToggleTintMode = true;
            this.mPasswordToggleTintMode = ViewUtils.parseTintMode(a.getInt(C0035R.styleable.TextInputLayout_passwordToggleTintMode, -1), null);
        }
        a.recycle();
    ...
    public void setTypeface(@Nullable Typeface typeface) {
        ...
        if (this.mTypeface == null && typeface != null) {
            this.mTypeface = typeface;
            this.mCollapsingTextHelper.setTypefaces(typeface);
            textView = this.mCounterView;
            if (textView != null) {
    ...
    public void dispatchProvideAutofillStructure(ViewStructure structure, int flags) {
        if (this.mOriginalHint != null) {
            CharSequence hint = this.mEditText;
            if (hint != null) {
                hint = hint.getHint();
    ...
    public void setErrorEnabled(boolean enabled) {
        if (this.mErrorEnabled != enabled) {
            ...
            if (enabled) {
                ...
                this.mErrorView.setId(C0035R.id.textinput_error);
                ...
                if (useDefaultColor) {
                    TextViewCompat.setTextAppearance(this.mErrorView, C0286R.style.TextAppearance_AppCompat_Caption);
                    this.mErrorView.setTextColor(ContextCompat.getColor(getContext(), C0286R.color.error_color_material));
                }
    ...
    public void setError(@Nullable CharSequence error) {
        ...
        if (ViewCompat.isLaidOut(this) && isEnabled()) {
            TextView textView = this.mErrorView;
            if (textView != null) {
                if (TextUtils.equals(textView.getText(), error)) {
                }
            }
            z = true;
            setError(error, z);
    ...
    private void setError(@Nullable final CharSequence error, boolean animate) {
        ...
        if (this.mErrorShown) {
            ...
            if (animate) {
                ...
                this.mErrorView.animate().alpha(1.0f).setDuration(200).setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR).setListener(new C00662()).start();
            } else {
        ...
        if (this.mCounterEnabled != enabled) {
            if (enabled) {
                ...
                try {
                    ...
                    TextViewCompat.setTextAppearance(this.mCounterView, C0286R.style.TextAppearance_AppCompat_Caption);
                    this.mCounterView.setTextColor(ContextCompat.getColor(getContext(), C0286R.color.error_color_material));
                }
    ...
    void updateCounter(int length) {
        ...
        if (i == -1) {
            ...
            if (wasCounterOverflowed != z) {
                TextViewCompat.setTextAppearance(this.mCounterView, z ? this.mCounterOverflowTextAppearance : this.mCounterTextAppearance);
            }
            this.mCounterView.setText(getContext().getString(C0035R.string.character_counter_pattern, new Object[]{Integer.valueOf(length), Integer.valueOf(this.mCounterMaxLength)}));
        }
    ...
    private void updateEditTextBackground() {
        Drawable editTextBackground = this.mEditText;
        if (editTextBackground != null) {
            editTextBackground = editTextBackground.getBackground();
            if (editTextBackground != null) {
                TextView textView;
        ...
        if (this.mEditText != null) {
            ...
            if (shouldShowPasswordIcon()) {
                if (this.mPasswordToggleView == null) {
                    this.mPasswordToggleView = (CheckableImageButton) LayoutInflater.from(getContext()).inflate(C0035R.layout.design_text_input_password_icon, this.mInputFrame, false);
