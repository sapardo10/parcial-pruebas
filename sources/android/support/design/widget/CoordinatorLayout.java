...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:32:0x0088 in {6, 8, 16, 18, 21, 22, 23, 25, 29, 31} preds:[]
...
*/
        ...
        LayoutParams(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0033R.styleable.CoordinatorLayout_Layout);
            this.gravity = a.getInteger(C0033R.styleable.CoordinatorLayout_Layout_android_layout_gravity, 0);
            this.mAnchorId = a.getResourceId(C0033R.styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.anchorGravity = a.getInteger(C0033R.styleable.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.keyline = a.getInteger(C0033R.styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.insetEdge = a.getInt(C0033R.styleable.CoordinatorLayout_Layout_layout_insetEdge, 0);
            this.dodgeInsetEdges = a.getInt(C0033R.styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
            this.mBehaviorResolved = a.hasValue(C0033R.styleable.CoordinatorLayout_Layout_layout_behavior);
            if (this.mBehaviorResolved) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attrs, a.getString(C0033R.styleable.CoordinatorLayout_Layout_layout_behavior));
            }
            a.recycle();
        ...
        boolean dependsOn(CoordinatorLayout parent, View child, View dependency) {
            if (dependency != this.mAnchorDirectChild) {
                if (!shouldDodge(dependency, ViewCompat.getLayoutDirection(parent))) {
                    Behavior behavior = this.mBehavior;
                    if (behavior != null) {
                        if (behavior.layoutDependsOn(parent, child, dependency)) {
                        }
                    }
                    return false;
                }
        ...
        View findAnchorView(CoordinatorLayout parent, View forChild) {
            ...
            if (this.mAnchorView != null) {
                if (verifyAnchorView(forChild, parent)) {
        ...
        private boolean shouldDodge(View other, int layoutDirection) {
            ...
            if (absInset != 0) {
                if ((GravityCompat.getAbsoluteGravity(this.dodgeInsetEdges, layoutDirection) & absInset) == absInset) {
                    return true;
                }
            }
            return false;
    ...
    class C08201 implements OnApplyWindowInsetsListener {
        C08201() {
        }
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs) {
        this(context, attrs, C0033R.attr.coordinatorLayoutStyle);
    }
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (defStyleAttr == 0) {
            a = context.obtainStyledAttributes(attrs, C0033R.styleable.CoordinatorLayout, 0, C0033R.style.Widget_Support_CoordinatorLayout);
        } else {
            a = context.obtainStyledAttributes(attrs, C0033R.styleable.CoordinatorLayout, defStyleAttr, 0);
        }
        int keylineArrayRes = a.getResourceId(C0033R.styleable.CoordinatorLayout_keylines, 0);
        ...
        this.mStatusBarBackground = a.getDrawable(C0033R.styleable.CoordinatorLayout_statusBarBackground);
        a.recycle();
        setupForInsets();
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        Behavior b = ((LayoutParams) r0.mBehaviorTouchView.getLayoutParams()).getBehavior();
        if (b != null) {
            handled = b.onTouchEvent(r0, r0.mBehaviorTouchView, motionEvent);
        }
        if (r0.mBehaviorTouchView == null) {
            handled |= super.onTouchEvent(ev);
        } else if (cancelSuper) {
            if (null == null) {
                ...
                cancelEvent = MotionEvent.obtain(now2, now2, 3, 0.0f, 0.0f, 0);
            }
            super.onTouchEvent(cancelEvent);
        }
        if (cancelEvent != null) {
    ...
    LayoutParams getResolvedLayoutParams(View child) {
        ...
        if (!result.mBehaviorResolved) {
            if (child instanceof AttachedBehavior) {
                ...
                CoordinatorLayout$DefaultBehavior defaultBehavior = null;
                for (Class<?> childClass = child.getClass(); childClass != null; childClass = childClass.getSuperclass()) {
                    CoordinatorLayout$DefaultBehavior coordinatorLayout$DefaultBehavior = (CoordinatorLayout$DefaultBehavior) childClass.getAnnotation(CoordinatorLayout$DefaultBehavior.class);
                    defaultBehavior = coordinatorLayout$DefaultBehavior;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (behavior != null) {
                    if (behavior.onLayoutChild(this, child, layoutDirection)) {
                    }
                }
    ...
    public boolean requestChildRectangleOnScreen(View child, Rect rectangle, boolean immediate) {
        Behavior behavior = ((LayoutParams) child.getLayoutParams()).getBehavior();
        if (behavior != null) {
            if (behavior.onRequestChildRectangleOnScreen(this, child, rectangle, immediate)) {
                return true;
            }
        }
        ...
        if (VERSION.SDK_INT >= 21) {
            if (ViewCompat.getFitsSystemWindows(this)) {
                if (this.mApplyWindowInsetsListener == null) {
                    this.mApplyWindowInsetsListener = new C08201();
                }
