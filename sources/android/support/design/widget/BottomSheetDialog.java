...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class C08162 extends AccessibilityDelegateCompat {
        C08162() {
        }
    ...
    class C08174 extends BottomSheetCallback {
        C08174() {
        }
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
        ...
        this.mBottomSheetCallback = new C08174();
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        FrameLayout container = (FrameLayout) View.inflate(getContext(), C0035R.layout.design_bottom_sheet_dialog, null);
        CoordinatorLayout coordinator = (CoordinatorLayout) container.findViewById(C0035R.id.coordinator);
        if (layoutResId != 0 && view == null) {
            view = getLayoutInflater().inflate(layoutResId, coordinator, false);
        }
        FrameLayout bottomSheet = (FrameLayout) coordinator.findViewById(C0035R.id.design_bottom_sheet);
        ...
        coordinator.findViewById(C0035R.id.touch_outside).setOnClickListener(new C00511());
        ViewCompat.setAccessibilityDelegate(bottomSheet, new C08162());
        bottomSheet.setOnTouchListener(new C00523());
        return container;
    }
    ...
    private static int getThemeResId(Context context, int themeId) {
        ...
        if (context.getTheme().resolveAttribute(C0035R.attr.bottomSheetDialogTheme, outValue, true)) {
            return outValue.resourceId;
        }
        return C0035R.style.Theme_Design_Light_BottomSheetDialog;
    }
}
