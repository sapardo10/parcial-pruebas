...
public class TabLayout extends HorizontalScrollView {
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        private void updateIndicatorPosition() {
            ...
            if (selectedTitle == null || selectedTitle.getWidth() <= 0) {
                ...
                if (this.mSelectionOffset > 0.0f && this.mSelectedPosition < getChildCount() - 1) {
                    ...
                    float left2 = this.mSelectionOffset * ((float) nextTitle.getLeft());
                    float f = this.mSelectionOffset;
                    left = (int) (left2 + ((1.0f - f) * ((float) left)));
                    right = (int) ((f * ((float) nextTitle.getRight())) + ((1.0f - this.mSelectionOffset) * ((float) right)));
                }
            }
        ...
        void setIndicatorPosition(int left, int right) {
            if (left == this.mIndicatorLeft) {
                if (right == this.mIndicatorRight) {
                    return;
                }
            }
        ...
        void animateIndicatorToPosition(int position, int duration) {
            ...
            if (Math.abs(i - r6.mSelectedPosition) <= 1) {
                ...
                if (i < r6.mSelectedPosition) {
                    if (isRtl) {
                        i2 = targetLeft - offset;
                        startLeft = i2;
                        startRight = i2;
                    } else {
                        i2 = targetRight + offset;
                        startLeft = i2;
                        startRight = i2;
                    }
                } else if (isRtl) {
            ...
            final int i4 = startLeft;
            final int i5 = targetLeft;
            final int i6 = startRight;
            C00631 c00631 = r0;
            final int i7 = targetRight;
            C00631 c006312 = new AnimatorUpdateListener() {
                public void onAnimationUpdate(ValueAnimator animator) {
                    float fraction = animator.getAnimatedFraction();
                    SlidingTabStrip.this.setIndicatorPosition(AnimationUtils.lerp(i4, i5, fraction), AnimationUtils.lerp(i6, i7, fraction));
                }
            };
            animator.addUpdateListener(c00631);
    ...
    class TabView extends LinearLayout {
        ...
        public void onMeasure(int origWidthMeasureSpec, int origHeightMeasureSpec) {
            ...
            if (r0.mTextView != null) {
                ...
                ImageView imageView = r0.mIconView;
                if (imageView == null || imageView.getVisibility() != 0) {
                    TextView textView = r0.mTextView;
                ...
                if (TabLayout.this.mMode == 1 && textSize > curTextSize && curLineCount == 1) {
                    ...
                    if (layout != null) {
                        if (approximateLineWidth(layout, 0, textSize) > ((float) ((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight()))) {
                        }
                    }
        ...
        final void update() {
            ...
            if (this.mCustomView == null) {
                if (this.mIconView == null) {
                    ImageView iconView = (ImageView) LayoutInflater.from(getContext()).inflate(C0035R.layout.design_layout_tab_icon, this, false);
                    addView(iconView, 0);
                    this.mIconView = iconView;
                }
                if (this.mTextView == null) {
                    textView = (TextView) LayoutInflater.from(getContext()).inflate(C0035R.layout.design_layout_tab_text, this, false);
                    addView(textView);
        ...
        private void updateTextAndIcon(@Nullable TextView textView, @Nullable ImageView iconView) {
            ...
            Tab tab3 = this.mTab;
            CharSequence contentDesc = tab3 != null ? tab3.getContentDescription() : null;
            if (iconView != null) {
                if (icon != null) {
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0035R.styleable.TabLayout, defStyleAttr, C0035R.style.Widget_Design_TabLayout);
        this.mTabStrip.setSelectedIndicatorHeight(a.getDimensionPixelSize(C0035R.styleable.TabLayout_tabIndicatorHeight, 0));
        this.mTabStrip.setSelectedIndicatorColor(a.getColor(C0035R.styleable.TabLayout_tabIndicatorColor, 0));
        int dimensionPixelSize = a.getDimensionPixelSize(C0035R.styleable.TabLayout_tabPadding, 0);
        this.mTabPaddingBottom = dimensionPixelSize;
        this.mTabPaddingEnd = dimensionPixelSize;
        this.mTabPaddingTop = dimensionPixelSize;
        this.mTabPaddingStart = dimensionPixelSize;
        this.mTabPaddingStart = a.getDimensionPixelSize(C0035R.styleable.TabLayout_tabPaddingStart, this.mTabPaddingStart);
        this.mTabPaddingTop = a.getDimensionPixelSize(C0035R.styleable.TabLayout_tabPaddingTop, this.mTabPaddingTop);
        this.mTabPaddingEnd = a.getDimensionPixelSize(C0035R.styleable.TabLayout_tabPaddingEnd, this.mTabPaddingEnd);
        this.mTabPaddingBottom = a.getDimensionPixelSize(C0035R.styleable.TabLayout_tabPaddingBottom, this.mTabPaddingBottom);
        this.mTabTextAppearance = a.getResourceId(C0035R.styleable.TabLayout_tabTextAppearance, C0035R.style.TextAppearance_Design_Tab);
        TypedArray ta = context.obtainStyledAttributes(this.mTabTextAppearance, C0286R.styleable.TextAppearance);
        try {
            this.mTabTextSize = (float) ta.getDimensionPixelSize(C0286R.styleable.TextAppearance_android_textSize, 0);
            this.mTabTextColors = ta.getColorStateList(C0286R.styleable.TextAppearance_android_textColor);
            if (a.hasValue(C0035R.styleable.TabLayout_tabTextColor)) {
                this.mTabTextColors = a.getColorStateList(C0035R.styleable.TabLayout_tabTextColor);
            }
            if (a.hasValue(C0035R.styleable.TabLayout_tabSelectedTextColor)) {
                this.mTabTextColors = createColorStateList(this.mTabTextColors.getDefaultColor(), a.getColor(C0035R.styleable.TabLayout_tabSelectedTextColor, 0));
            }
            this.mRequestedTabMinWidth = a.getDimensionPixelSize(C0035R.styleable.TabLayout_tabMinWidth, -1);
            this.mRequestedTabMaxWidth = a.getDimensionPixelSize(C0035R.styleable.TabLayout_tabMaxWidth, -1);
            this.mTabBackgroundResId = a.getResourceId(C0035R.styleable.TabLayout_tabBackground, 0);
            this.mContentInsetStart = a.getDimensionPixelSize(C0035R.styleable.TabLayout_tabContentStart, 0);
            this.mMode = a.getInt(C0035R.styleable.TabLayout_tabMode, 1);
            this.mTabGravity = a.getInt(C0035R.styleable.TabLayout_tabGravity, 0);
            a.recycle();
            Resources res = getResources();
            this.mTabTextMultiLineSize = (float) res.getDimensionPixelSize(C0035R.dimen.design_tab_text_size_2line);
            this.mScrollableTabMinWidth = res.getDimensionPixelSize(C0035R.dimen.design_tab_scrollable_min_width);
            applyModeAndGravity();
        } finally {
            ta.recycle();
        }
    ...
    void populateFromPagerAdapter() {
        removeAllTabs();
        int adapterCount = this.mPagerAdapter;
        if (adapterCount != 0) {
            int i;
            adapterCount = adapterCount.getCount();
            for (i = 0; i < adapterCount; i++) {
                addTab(newTab().setText(this.mPagerAdapter.getPageTitle(i)), false);
            }
            i = this.mViewPager;
            if (i != 0 && adapterCount > 0) {
                i = i.getCurrentItem();
