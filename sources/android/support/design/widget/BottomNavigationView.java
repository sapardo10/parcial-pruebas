...
public class BottomNavigationView extends FrameLayout {
    ...
    class C08141 implements Callback {
        C08141() {
        }
        ...
        public boolean onMenuItemSelected(MenuBuilder menu, MenuItem item) {
            ...
            if (BottomNavigationView.this.mReselectedListener == null || item.getItemId() != BottomNavigationView.this.getSelectedItemId()) {
                if (BottomNavigationView.this.mSelectedListener != null) {
                    if (!BottomNavigationView.this.mSelectedListener.onNavigationItemSelected(item)) {
                        return z;
                    }
                }
                z = false;
    ...
    public BottomNavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0035R.styleable.BottomNavigationView, defStyleAttr, C0035R.style.Widget_Design_BottomNavigationView);
        if (a.hasValue(C0035R.styleable.BottomNavigationView_itemIconTint)) {
            this.mMenuView.setIconTintList(a.getColorStateList(C0035R.styleable.BottomNavigationView_itemIconTint));
        } else {
            this.mMenuView.setIconTintList(createDefaultColorStateList(16842808));
        }
        if (a.hasValue(C0035R.styleable.BottomNavigationView_itemTextColor)) {
            this.mMenuView.setItemTextColor(a.getColorStateList(C0035R.styleable.BottomNavigationView_itemTextColor));
        } else {
            this.mMenuView.setItemTextColor(createDefaultColorStateList(16842808));
        }
        if (a.hasValue(C0035R.styleable.BottomNavigationView_elevation)) {
            ViewCompat.setElevation(this, (float) a.getDimensionPixelSize(C0035R.styleable.BottomNavigationView_elevation, 0));
        }
        this.mMenuView.setItemBackgroundRes(a.getResourceId(C0035R.styleable.BottomNavigationView_itemBackground, 0));
        if (a.hasValue(C0035R.styleable.BottomNavigationView_menu)) {
            inflateMenu(a.getResourceId(C0035R.styleable.BottomNavigationView_menu, 0));
        }
        a.recycle();
        ...
        this.mMenu.setCallback(new C08141());
    }
    ...
    private void addCompatibilityTopDivider(Context context) {
        ...
        divider.setBackgroundColor(ContextCompat.getColor(context, C0035R.color.design_bottom_navigation_shadow_color));
        divider.setLayoutParams(new LayoutParams(-1, getResources().getDimensionPixelSize(C0035R.dimen.design_bottom_navigation_shadow_height)));
        addView(divider);
    }
