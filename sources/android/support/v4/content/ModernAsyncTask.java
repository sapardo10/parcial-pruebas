...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C01491();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C08332();

    /* renamed from: android.support.v4.content.ModernAsyncTask$1 */
    static class C01491 implements ThreadFactory {
    ...
    class C08332 extends WorkerRunnable<Params, Result> {
        C08332() {
        }
