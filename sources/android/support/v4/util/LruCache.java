...
*/
    ...
    public final V remove(K r6) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:23:0x0031 in {7, 8, 11, 12, 13, 15, 18, 20, 22} preds:[]
	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.computeDominators(BlockProcessor.java:129)
	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.processBlocksTree(BlockProcessor.java:48)
	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.visit(BlockProcessor.java:38)
	at jadx.core.dex.visitors.DepthTraversal.visit(DepthTraversal.java:31)
...
*/
    ...
    L_0x0002:
        monitor-enter(r5);
        r0 = 0;
        r1 = r5.map;	 Catch:{ all -> 0x0021 }
        r1 = r1.remove(r6);	 Catch:{ all -> 0x0021 }
        if (r1 == 0) goto L_0x0016;
    L_0x000c:
        r2 = r5.size;	 Catch:{ all -> 0x0027 }
        r3 = r5.safeSizeOf(r6, r1);	 Catch:{ all -> 0x0027 }
        r2 = r2 - r3;	 Catch:{ all -> 0x0027 }
        r5.size = r2;	 Catch:{ all -> 0x0027 }
        goto L_0x0017;	 Catch:{ all -> 0x0027 }
    L_0x0017:
    ...
    L_0x0021:
        ...
        r1 = r3.getKey();	 Catch:{ all -> 0x0075 }
        r2 = r3.getValue();	 Catch:{ all -> 0x0078 }
        r4 = r6.map;	 Catch:{ all -> 0x0078 }
        r4.remove(r1);	 Catch:{ all -> 0x0078 }
        r4 = r6.size;	 Catch:{ all -> 0x0078 }
        r5 = r6.safeSizeOf(r1, r2);	 Catch:{ all -> 0x0078 }
        r4 = r4 - r5;
        r6.size = r4;	 Catch:{ all -> 0x0078 }
        r4 = r6.evictionCount;	 Catch:{ all -> 0x0078 }
        r5 = 1;
        r4 = r4 + r5;
