...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C01472();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C01461();
    ...
    class C01472 implements OnItemClickListener {
        C01472() {
        }
