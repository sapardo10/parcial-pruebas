...
public final class NotificationManagerCompat {
    ...
    public static java.util.Set<java.lang.String> getEnabledListenerPackages(@android.support.annotation.NonNull android.content.Context r9) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:22:0x004a in {10, 11, 12, 13, 14, 15, 18, 21} preds:[]
...
*/
        ...
        r1 = "enabled_notification_listeners";
        r0 = android.provider.Settings.Secure.getString(r0, r1);
        r1 = sEnabledNotificationListenersLock;
        monitor-enter(r1);
        if (r0 == 0) goto L_0x0042;
    L_0x0010:
        r2 = sEnabledNotificationListeners;	 Catch:{ all -> 0x0047 }
        r2 = r0.equals(r2);	 Catch:{ all -> 0x0047 }
        if (r2 != 0) goto L_0x0041;	 Catch:{ all -> 0x0047 }
    L_0x0018:
        r2 = ":";	 Catch:{ all -> 0x0047 }
        r2 = r0.split(r2);	 Catch:{ all -> 0x0047 }
        r3 = new java.util.HashSet;	 Catch:{ all -> 0x0047 }
        r4 = r2.length;	 Catch:{ all -> 0x0047 }
        r3.<init>(r4);	 Catch:{ all -> 0x0047 }
        r4 = r2.length;	 Catch:{ all -> 0x0047 }
        r5 = 0;	 Catch:{ all -> 0x0047 }
    L_0x0026:
        if (r5 >= r4) goto L_0x003c;	 Catch:{ all -> 0x0047 }
    L_0x0028:
        r6 = r2[r5];	 Catch:{ all -> 0x0047 }
        r7 = android.content.ComponentName.unflattenFromString(r6);	 Catch:{ all -> 0x0047 }
        if (r7 == 0) goto L_0x0038;	 Catch:{ all -> 0x0047 }
    L_0x0030:
        r8 = r7.getPackageName();	 Catch:{ all -> 0x0047 }
        r3.add(r8);	 Catch:{ all -> 0x0047 }
        goto L_0x0039;	 Catch:{ all -> 0x0047 }
    L_0x0039:
        r5 = r5 + 1;	 Catch:{ all -> 0x0047 }
        goto L_0x0026;	 Catch:{ all -> 0x0047 }
    L_0x003c:
        sEnabledNotificationListenerPackages = r3;	 Catch:{ all -> 0x0047 }
        sEnabledNotificationListeners = r0;	 Catch:{ all -> 0x0047 }
        goto L_0x0043;	 Catch:{ all -> 0x0047 }
    L_0x0041:
        goto L_0x0043;	 Catch:{ all -> 0x0047 }
    L_0x0043:
        r2 = sEnabledNotificationListenerPackages;	 Catch:{ all -> 0x0047 }
        monitor-exit(r1);	 Catch:{ all -> 0x0047 }
        return r2;	 Catch:{ all -> 0x0047 }
    L_0x0047:
        r2 = move-exception;	 Catch:{ all -> 0x0047 }
        monitor-exit(r1);	 Catch:{ all -> 0x0047 }
        throw r2;
        return;
        */
