...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner {
    ...
    class C08302 extends FragmentContainer {
        C08302() {
        }
    ...
    public final boolean isVisible() {
        if (isAdded() && !isHidden()) {
            ...
            if (view != null) {
                return view.getWindowToken() != null && this.mView.getVisibility() == 0;
            }
        }
    }
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        if (!this.mUserVisibleHint && isVisibleToUser && this.mState < 4 && this.mFragmentManager != null) {
            if (isAdded()) {
        ...
        if (fragmentManagerImpl != null) {
            if (fragmentManagerImpl.mHost != null) {
                if (Looper.myLooper() != this.mFragmentManager.mHost.getHandler().getLooper()) {
                    this.mFragmentManager.mHost.getHandler().postAtFrontOfQueue(new C01231());
                    return;
                } else {
    ...
    private void callStartTransitionListener() {
        OnStartEnterTransitionListener listener = this.mAnimationInfo;
        if (listener == null) {
            listener = null;
        } else {
            listener.mEnterTransitionPostponed = false;
            listener = listener.mStartEnterTransitionListener;
    ...
    void instantiateChildFragmentManager() {
        if (this.mHost != null) {
            ...
            this.mChildFragmentManager.attachController(this.mHost, new C08302(), this);
            return;
        }
    ...
    boolean performOptionsItemSelected(MenuItem item) {
        if (!this.mHidden) {
            ...
            FragmentManagerImpl fragmentManagerImpl = this.mChildFragmentManager;
            if (fragmentManagerImpl != null) {
                if (fragmentManagerImpl.dispatchOptionsItemSelected(item)) {
                    return true;
                }
            }
        }
    ...
    boolean performContextItemSelected(MenuItem item) {
        if (!this.mHidden) {
            ...
            FragmentManagerImpl fragmentManagerImpl = this.mChildFragmentManager;
            if (fragmentManagerImpl != null) {
                if (fragmentManagerImpl.dispatchContextItemSelected(item)) {
                    return true;
                }
            }
        }
