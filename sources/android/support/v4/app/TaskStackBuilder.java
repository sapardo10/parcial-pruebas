...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:11:0x0030 in {5, 7, 10} preds:[]
...
*/
        ...
        r0 = r4.mIntents;
        r0 = r0.size();
        r1 = r4.mSourceContext;	 Catch:{ NameNotFoundException -> 0x0022 }
        r1 = android.support.v4.app.NavUtils.getParentActivityIntent(r1, r5);	 Catch:{ NameNotFoundException -> 0x0022 }
    L_0x000c:
        if (r1 == 0) goto L_0x001f;	 Catch:{ NameNotFoundException -> 0x0022 }
    L_0x000e:
        r2 = r4.mIntents;	 Catch:{ NameNotFoundException -> 0x0022 }
        r2.add(r0, r1);	 Catch:{ NameNotFoundException -> 0x0022 }
        r2 = r4.mSourceContext;	 Catch:{ NameNotFoundException -> 0x0022 }
        r3 = r1.getComponent();	 Catch:{ NameNotFoundException -> 0x0022 }
        r2 = android.support.v4.app.NavUtils.getParentActivityIntent(r2, r3);	 Catch:{ NameNotFoundException -> 0x0022 }
        r1 = r2;
        goto L_0x000c;
        return r4;
    L_0x0022:
    ...
    public void startActivities(@Nullable Bundle options) {
        ...
        if (!ContextCompat.startActivities(this.mSourceContext, intents, options)) {
            ...
            topIntent.addFlags(C0555C.ENCODING_PCM_MU_LAW);
