...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C02571();
    ...
    private final Runnable mSetIdleRunnable = new C02582();
    private int mTouchSlop;
    private int mTrackingEdges;
    private VelocityTracker mVelocityTracker;

    /* renamed from: android.support.v4.widget.ViewDragHelper$1 */
    static class C02571 implements Interpolator {
        C02571() {
        }
                        ...
                        if (isValidPointerForActionMove(pointerId2)) {
                            ...
                            if (this.mDragState != 1) {
                                ...
                                if (checkTouchSlop(toCapture, dx, dy)) {
                                    if (tryCaptureViewForDrag(toCapture, pointerId2)) {
                                    }
                                }
                            }
                            saveLastMotion(ev);
