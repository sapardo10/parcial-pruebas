...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C01981();
    ...
    static class C01981 implements Creator<PlaybackStateCompat> {
        C01981() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C01991();
        ...
        static class C01991 implements Creator<CustomAction> {
            C01991() {
            }
