...
public final class MediaControllerCompat {
    ...
    public static abstract class Callback implements DeathRecipient {
        ...
        void postToHandler(int what, Object obj, Bundle data) {
            ...
            if (msg != null) {
                msg = msg.obtainMessage(what, obj);
                msg.setData(data);
                msg.sendToTarget();
            }
        }
...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:24:0x0045 in {2, 14, 16, 17, 20, 23} preds:[]
...
*/
        ...
        L_0x0004:
            return;
        L_0x0005:
            r0 = r6.mPendingCallbacks;
            monitor-enter(r0);
            r1 = r6.mPendingCallbacks;	 Catch:{ all -> 0x0042 }
            r1 = r1.iterator();	 Catch:{ all -> 0x0042 }
        L_0x000e:
            r2 = r1.hasNext();	 Catch:{ all -> 0x0042 }
            if (r2 == 0) goto L_0x003a;	 Catch:{ all -> 0x0042 }
        L_0x0014:
            r2 = r1.next();	 Catch:{ all -> 0x0042 }
            r2 = (android.support.v4.media.session.MediaControllerCompat.Callback) r2;	 Catch:{ all -> 0x0042 }
            r3 = new android.support.v4.media.session.MediaControllerCompat$MediaControllerImplApi21$ExtraCallback;	 Catch:{ all -> 0x0042 }
            r3.<init>(r2);	 Catch:{ all -> 0x0042 }
            r4 = r6.mCallbackMap;	 Catch:{ all -> 0x0042 }
            r4.put(r2, r3);	 Catch:{ all -> 0x0042 }
            r4 = 1;	 Catch:{ all -> 0x0042 }
            r2.mHasExtraCallback = r4;	 Catch:{ all -> 0x0042 }
            r4 = r6.mExtraBinder;	 Catch:{ RemoteException -> 0x0031 }
            r4.registerCallbackListener(r3);	 Catch:{ RemoteException -> 0x0031 }
            r2.onSessionReady();	 Catch:{ all -> 0x0042 }
            goto L_0x000e;	 Catch:{ all -> 0x0042 }
        L_0x0031:
            r1 = move-exception;	 Catch:{ all -> 0x0042 }
            r4 = "MediaControllerCompat";	 Catch:{ all -> 0x0042 }
            r5 = "Dead object in registerCallback.";	 Catch:{ all -> 0x0042 }
            android.util.Log.e(r4, r5, r1);	 Catch:{ all -> 0x0042 }
            goto L_0x003b;	 Catch:{ all -> 0x0042 }
        L_0x003b:
            r1 = r6.mPendingCallbacks;	 Catch:{ all -> 0x0042 }
            ...
            if (hashCode != -1348483723) {
                if (hashCode == 503011406 && action.equals(MediaSessionCompat.ACTION_UNFOLLOW)) {
                    ...
                    switch (obj) {
                        ...
                        case 1:
                            if (args == null) {
                                if (!args.containsKey(MediaSessionCompat.ARGUMENT_MEDIA_ATTRIBUTE)) {
                                    break;
                                }
                            }
