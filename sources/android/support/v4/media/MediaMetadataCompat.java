...
public final class MediaMetadataCompat implements Parcelable {
    public static final Creator<MediaMetadataCompat> CREATOR = new C01891();
    ...
    static class C01891 implements Creator<MediaMetadataCompat> {
        C01891() {
        }
        ...
        public Builder(MediaMetadataCompat source, int maxBitmapSize) {
            ...
            for (String key : this.mBundle.keySet()) {
                ...
                if (value instanceof Bitmap) {
                    Bitmap bmp = value;
                    if (bmp.getHeight() <= maxBitmapSize) {
                        if (bmp.getWidth() > maxBitmapSize) {
                        }
                    }
