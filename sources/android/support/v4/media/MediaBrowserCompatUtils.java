    ...
    public static boolean areSameOptions(Bundle options1, Bundle options2) {
        ...
        if (options1 == null) {
            if (options2.getInt(MediaBrowserCompat.EXTRA_PAGE, -1) == -1) {
                if (options2.getInt(MediaBrowserCompat.EXTRA_PAGE_SIZE, -1) == -1) {
                    return z;
                }
            }
            z = false;
            ...
            if (options1.getInt(MediaBrowserCompat.EXTRA_PAGE, -1) == -1) {
                if (options1.getInt(MediaBrowserCompat.EXTRA_PAGE_SIZE, -1) == -1) {
                    return z;
                }
            }
            z = false;
            ...
            if (options1.getInt(MediaBrowserCompat.EXTRA_PAGE, -1) == options2.getInt(MediaBrowserCompat.EXTRA_PAGE, -1)) {
                if (options1.getInt(MediaBrowserCompat.EXTRA_PAGE_SIZE, -1) == options2.getInt(MediaBrowserCompat.EXTRA_PAGE_SIZE, -1)) {
                    return z;
                }
            }
            z = false;
