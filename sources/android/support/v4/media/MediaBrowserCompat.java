...
public final class MediaBrowserCompat {
    ...
    public static class MediaItem implements Parcelable {
        public static final Creator<MediaItem> CREATOR = new C01731();
        ...
        static class C01731 implements Creator<MediaItem> {
            C01731() {
            }
    ...
    static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public void connect() {
            ...
            this.mState = 2;
            this.mHandler.post(new C01651());
        }

        public void disconnect() {
            this.mState = 0;
            this.mHandler.post(new C01662());
        }
