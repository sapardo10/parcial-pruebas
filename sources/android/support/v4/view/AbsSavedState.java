...
public abstract class AbsSavedState implements Parcelable {
    public static final Creator<AbsSavedState> CREATOR = new C02252();
    public static final AbsSavedState EMPTY_STATE = new C08511();
    private final Parcelable mSuperState;

    /* renamed from: android.support.v4.view.AbsSavedState$2 */
    static class C02252 implements ClassLoaderCreator<AbsSavedState> {
        C02252() {
        }
    ...
    static class C08511 extends AbsSavedState {
        C08511() {
            super();
        }
    }
