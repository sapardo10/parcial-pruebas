...
public class ViewPager extends ViewGroup {
    ...
    class C08524 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:165:0x02c3 in {2, 3, 7, 11, 14, 24, 25, 26, 29, 30, 34, 35, 38, 39, 46, 53, 54, 55, 56, 63, 64, 65, 68, 69, 70, 71, 76, 77, 79, 80, 87, 94, 95, 96, 97, 104, 105, 106, 109, 110, 111, 112, 113, 114, 115, 116, 125, 126, 127, 128, 133, 134, 139, 140, 150, 151, 152, 153, 154, 155, 156, 160, 162, 164} preds:[]
...
*/
    ...
    L_0x0266:
        r17 = r4;
        r18 = r5;
        r0 = r19.getResources();	 Catch:{ NotFoundException -> 0x0277 }
        r2 = r19.getId();	 Catch:{ NotFoundException -> 0x0277 }
        r0 = r0.getResourceName(r2);	 Catch:{ NotFoundException -> 0x0277 }
        goto L_0x0280;
    L_0x0277:
        r0 = move-exception;
        r2 = r19.getId();
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C08524());
    }
