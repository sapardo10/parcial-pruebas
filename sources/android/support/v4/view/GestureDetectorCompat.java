            ...
            switch (action & 255) {
                case 0:
                    ...
                    if (r0.mDoubleTapListener != null) {
                        ...
                        motionEvent2 = r0.mCurrentDownEvent;
                        if (motionEvent2 != null) {
                            MotionEvent motionEvent3 = r0.mPreviousUpEvent;
                            if (motionEvent3 != null && hadTapMessage) {
                    ...
                    MotionEvent motionEvent4 = r0.mCurrentDownEvent;
                ...
                case 1:
                    ...
                    if (r0.mIsDoubleTapping) {
                        ...
                        if (r0.mDeferConfirmSingleTap) {
                            OnDoubleTapListener onDoubleTapListener = r0.mDoubleTapListener;
                            if (onDoubleTapListener != null) {
                                onDoubleTapListener.onSingleTapConfirmed(motionEvent);
                            }
                        }
                    } else {
                        velocityTracker = r0.mVelocityTracker;
                        pointerId = motionEvent.getPointerId(0);
                        velocityTracker.computeCurrentVelocity(1000, (float) r0.mMaximumFlingVelocity);
                        float velocityY = velocityTracker.getYVelocity(pointerId);
                        float velocityX = velocityTracker.getXVelocity(pointerId);
                        if (Math.abs(velocityY) <= ((float) r0.mMinimumFlingVelocity)) {
                            if (Math.abs(velocityX) > ((float) r0.mMinimumFlingVelocity)) {
                            }
                        }
                        handled = r0.mListener.onFling(r0.mCurrentDownEvent, motionEvent, velocityX, velocityY);
                    }
                    motionEvent2 = r0.mPreviousUpEvent;
                    if (motionEvent2 != null) {
                ...
                case 6:
                    ...
                    int id1 = motionEvent.getPointerId(pointerId);
                    float x1 = r0.mVelocityTracker.getXVelocity(id1);
                    float y1 = r0.mVelocityTracker.getYVelocity(id1);
                    int i3 = action;
                    action = 0;
                    while (action < count) {
                        if (action == pointerId) {
                            ...
                            upIndex = pointerId;
                            boolean id2;
                            if ((r0.mVelocityTracker.getXVelocity(pointerUp) * x1) + (r0.mVelocityTracker.getYVelocity(pointerUp) * y1) < 0.0f) {
                                id2 = pointerUp;
