...
class TypefaceCompatBaseImpl implements TypefaceCompatImpl {
    ...
    class C08341 implements StyleExtractor<FontInfo> {
        C08341() {
        }
    ...
    class C08352 implements StyleExtractor<FontFileResourceEntry> {
        C08352() {
        }
    ...
    protected FontInfo findBestInfo(FontInfo[] fonts, int style) {
        return (FontInfo) findBestFont(fonts, style, new C08341());
    }
    ...
    private FontFileResourceEntry findBestEntry(FontFamilyFilesResourceEntry entry, int style) {
        return (FontFileResourceEntry) findBestFont(entry.getEntries(), style, new C08352());
    }
