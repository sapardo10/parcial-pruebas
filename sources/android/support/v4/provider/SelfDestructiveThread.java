...
public class SelfDestructiveThread {
    ...
    private Callback mCallback = new C02191();
    ...
    class C02191 implements Callback {
        C02191() {
        }
    ...
    class C02223 implements Runnable {
        ...
        C02223(AtomicReference atomicReference, Callable callable, ReentrantLock reentrantLock, AtomicBoolean atomicBoolean, Condition condition) {
...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:28:0x0062 in {6, 11, 12, 18, 21, 24, 27} preds:[]
...
*/
        ...
        r10.post(r8);
        r4.lock();
        r0 = r5.get();	 Catch:{ all -> 0x005d }
        if (r0 != 0) goto L_0x0031;	 Catch:{ all -> 0x005d }
    L_0x0029:
        r0 = r2.get();	 Catch:{ all -> 0x005d }
        r4.unlock();
        return r0;
    L_0x0031:
        r0 = java.util.concurrent.TimeUnit.MILLISECONDS;	 Catch:{ all -> 0x005d }
        r8 = (long) r12;	 Catch:{ all -> 0x005d }
        r0 = r0.toNanos(r8);	 Catch:{ all -> 0x005d }
    L_0x0038:
    ...
    L_0x003e:
        r3 = move-exception;
    L_0x003f:
        r3 = r5.get();	 Catch:{ all -> 0x005d }
        if (r3 != 0) goto L_0x004d;	 Catch:{ all -> 0x005d }
    L_0x0045:
        r3 = r2.get();	 Catch:{ all -> 0x005d }
        r4.unlock();
        return r3;
    L_0x004d:
        r8 = 0;
    ...
    L_0x0053:
        goto L_0x0038;
    L_0x0054:
        r3 = new java.lang.InterruptedException;	 Catch:{ all -> 0x005d }
        r6 = "timeout";	 Catch:{ all -> 0x005d }
        r3.<init>(r6);	 Catch:{ all -> 0x005d }
