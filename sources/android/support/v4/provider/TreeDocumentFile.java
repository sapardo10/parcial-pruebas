...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:21:0x0082 in {6, 13, 17, 18, 20} preds:[]
...
*/
        ...
        r9 = 0;
        r1 = 1;
        r3 = new java.lang.String[r1];	 Catch:{ Exception -> 0x0043 }
        r1 = "document_id";	 Catch:{ Exception -> 0x0043 }
        r10 = 0;	 Catch:{ Exception -> 0x0043 }
        r3[r10] = r1;	 Catch:{ Exception -> 0x0043 }
        r4 = 0;	 Catch:{ Exception -> 0x0043 }
        r5 = 0;	 Catch:{ Exception -> 0x0043 }
        r6 = 0;	 Catch:{ Exception -> 0x0043 }
        r1 = r0;	 Catch:{ Exception -> 0x0043 }
        r2 = r7;	 Catch:{ Exception -> 0x0043 }
        r1 = r1.query(r2, r3, r4, r5, r6);	 Catch:{ Exception -> 0x0043 }
        r9 = r1;	 Catch:{ Exception -> 0x0043 }
    L_0x0029:
        r1 = r9.moveToNext();	 Catch:{ Exception -> 0x0043 }
        if (r1 == 0) goto L_0x003d;	 Catch:{ Exception -> 0x0043 }
    L_0x002f:
        r1 = r9.getString(r10);	 Catch:{ Exception -> 0x0043 }
        r2 = r11.mUri;	 Catch:{ Exception -> 0x0043 }
        r2 = android.provider.DocumentsContract.buildDocumentUriUsingTree(r2, r1);	 Catch:{ Exception -> 0x0043 }
        r8.add(r2);	 Catch:{ Exception -> 0x0043 }
        goto L_0x0029;
    L_0x003d:
        closeQuietly(r9);
        goto L_0x005c;
    ...
    L_0x0043:
        r1 = move-exception;
        r2 = "DocumentFile";	 Catch:{ all -> 0x0041 }
        r3 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0041 }
        r3.<init>();	 Catch:{ all -> 0x0041 }
        r4 = "Failed query: ";	 Catch:{ all -> 0x0041 }
        r3.append(r4);	 Catch:{ all -> 0x0041 }
        r3.append(r1);	 Catch:{ all -> 0x0041 }
        r3 = r3.toString();	 Catch:{ all -> 0x0041 }
        android.util.Log.w(r2, r3);	 Catch:{ all -> 0x0041 }
        goto L_0x003d;
    L_0x005c:
        r1 = r8.size();
