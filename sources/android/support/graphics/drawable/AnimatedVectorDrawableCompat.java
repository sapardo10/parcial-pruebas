    ...
    private static class AnimatedVectorDrawableCompatState extends ConstantState {
        ...
        public AnimatedVectorDrawableCompatState(Context context, AnimatedVectorDrawableCompatState copy, Callback owner, Resources res) {
            if (copy != null) {
                ...
                int numAnimators = copy.mAnimators;
                if (numAnimators != 0) {
                    numAnimators = numAnimators.size();
        ...
        while (eventType != 1) {
            ...
            if (eventType == 2) {
                ...
                if (ANIMATED_VECTOR.equals(tagName)) {
                    ...
                    if (id != 0) {
                        Animator objectAnimator = this.mContext;
                        if (objectAnimator != null) {
                            setupAnimatorsForTarget(target, AnimatorInflaterCompat.loadAnimator(objectAnimator, id));
                        } else {
                            a.recycle();
