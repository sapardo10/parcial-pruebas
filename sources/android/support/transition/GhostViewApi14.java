...
class GhostViewApi14 extends View implements GhostViewImpl {
    ...
    private final OnPreDrawListener mOnPreDrawListener = new C00961();
    int mReferences;
    ...
    class C00961 implements OnPreDrawListener {
        C00961() {
        }
    ...
    private static void setGhostView(@NonNull View view, GhostViewApi14 ghostView) {
        view.setTag(C0100R.id.ghost_view, ghostView);
    }

    static GhostViewApi14 getGhostView(@NonNull View view) {
        return (GhostViewApi14) view.getTag(C0100R.id.ghost_view);
    }
}
