...
public class ChangeImageTransform extends Transition {
    ...
    private static final TypeEvaluator<Matrix> NULL_MATRIX_EVALUATOR = new C00901();
    ...
    static class C00901 implements TypeEvaluator<Matrix> {
        C00901() {
        }
    ...
    private static Matrix copyImageMatrix(ImageView view) {
        switch (C00923.$SwitchMap$android$widget$ImageView$ScaleType[view.getScaleType().ordinal()]) {
            case 1:
