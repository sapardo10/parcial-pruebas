...
public class ChangeTransform extends Transition {
    ...
    private static class Transforms {
        ...
        public int hashCode() {
            ...
            int i = 0;
            int code = (f != 0.0f ? Float.floatToIntBits(f) : 0) * 31;
            float f2 = this.mTranslationY;
            int floatToIntBits = (code + (f2 != 0.0f ? Float.floatToIntBits(f2) : 0)) * 31;
            f2 = this.mTranslationZ;
            code = (floatToIntBits + (f2 != 0.0f ? Float.floatToIntBits(f2) : 0)) * 31;
            f2 = this.mScaleX;
            floatToIntBits = (code + (f2 != 0.0f ? Float.floatToIntBits(f2) : 0)) * 31;
            f2 = this.mScaleY;
            code = (floatToIntBits + (f2 != 0.0f ? Float.floatToIntBits(f2) : 0)) * 31;
            f2 = this.mRotationX;
            floatToIntBits = (code + (f2 != 0.0f ? Float.floatToIntBits(f2) : 0)) * 31;
    ...
    private static class GhostListener extends TransitionListenerAdapter {
        ...
        public void onTransitionEnd(@NonNull Transition transition) {
            ...
            this.mView.setTag(C0100R.id.transition_transform, null);
            this.mView.setTag(C0100R.id.parent_matrix, null);
        }
            ...
            if (matrix != null) {
                if (!matrix.isIdentity()) {
                    ...
                    if (this.mReparent) {
                        ...
                        transitionValues.values.put(PROPNAME_INTERMEDIATE_MATRIX, view.getTag(C0100R.id.transition_transform));
                        transitionValues.values.put(PROPNAME_INTERMEDIATE_PARENT_MATRIX, view.getTag(C0100R.id.parent_matrix));
                    }
                }
            }
            matrix = null;
    ...
    public Animator createAnimator(@NonNull ViewGroup sceneRoot, TransitionValues startValues, TransitionValues endValues) {
        if (startValues != null && endValues != null) {
            if (startValues.values.containsKey(PROPNAME_PARENT)) {
    ...
    private ObjectAnimator createTransformAnimator(TransitionValues startValues, TransitionValues endValues, boolean handleParentChange) {
        ...
        AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                if (!this.mIsCanceled) {
                    if (z && ChangeTransform.this.mUseOverlay) {
                        ...
                        view2.setTag(C0100R.id.transition_transform, null);
                        view2.setTag(C0100R.id.parent_matrix, null);
                    }
                }
            ...
            private void setCurrentMatrix(Matrix currentMatrix) {
                ...
                view2.setTag(C0100R.id.transition_transform, this.mTempMatrix);
                transforms2.restore(view2);
            }
        };
    ...
    private void setMatricesForParent(TransitionValues startValues, TransitionValues endValues) {
        ...
        endValues.view.setTag(C0100R.id.parent_matrix, endParentMatrix);
