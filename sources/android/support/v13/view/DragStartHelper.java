...
public class DragStartHelper {
    ...
    private final OnLongClickListener mLongClickListener = new C01081();
    private final OnTouchListener mTouchListener = new C01092();
    private final View mView;

    /* renamed from: android.support.v13.view.DragStartHelper$1 */
    class C01081 implements OnLongClickListener {
        C01081() {
        }
    ...
    class C01092 implements OnTouchListener {
        C01092() {
        }
