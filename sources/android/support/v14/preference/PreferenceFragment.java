...
public abstract class PreferenceFragment extends Fragment implements OnPreferenceTreeClickListener, OnDisplayPreferenceDialogListener, OnNavigateToScreenListener, TargetFragment {
    ...
    private final Handler mHandler = new C01151();
    private boolean mHavePrefs;
    private boolean mInitDone;
    private int mLayoutResId = C0315R.layout.preference_list_fragment;
    private RecyclerView mList;
    private PreferenceManager mPreferenceManager;
    private final Runnable mRequestFocus = new C01162();
    private Runnable mSelectPreferenceRunnable;
    private Context mStyledContext;

    /* renamed from: android.support.v14.preference.PreferenceFragment$1 */
    ...
    /* renamed from: android.support.v14.preference.PreferenceFragment$2 */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        TypedArray a = this.mStyledContext.obtainStyledAttributes(null, C0315R.styleable.PreferenceFragment, TypedArrayUtils.getAttr(this.mStyledContext, C0315R.attr.preferenceFragmentStyle, AndroidResources.ANDROID_R_PREFERENCE_FRAGMENT_STYLE), 0);
        this.mLayoutResId = a.getResourceId(C0315R.styleable.PreferenceFragment_android_layout, this.mLayoutResId);
        Drawable divider = a.getDrawable(C0315R.styleable.PreferenceFragment_android_divider);
        int dividerHeight = a.getDimensionPixelSize(C0315R.styleable.PreferenceFragment_android_dividerHeight, -1);
        boolean allowDividerAfterLastItem = a.getBoolean(C0315R.styleable.PreferenceFragment_allowDividerAfterLastItem, true);
        a.recycle();
        TypedValue tv = new TypedValue();
        getActivity().getTheme().resolveAttribute(C0315R.attr.preferenceTheme, tv, true);
