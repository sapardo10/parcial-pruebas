...
import android.support.wearable.view.WearableRecyclerView.OffsettingHelper;
import android.view.View;

@TargetApi(23)
@Deprecated
public class DefaultOffsettingHelper extends OffsettingHelper {
    ...
    public void updateChild(View child, WearableRecyclerView parent) {
        if (this.mParentView != parent) {
            ...
            this.mXCurveOffset = this.mParentView.getResources().getDimensionPixelSize(C0395R.dimen.wrv_curve_default_x_offset);
