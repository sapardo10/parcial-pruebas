...
public class AsyncListUtil<T> {
    ...
    private final BackgroundCallback<T> mBackgroundCallback = new C08732();
    final BackgroundCallback<T> mBackgroundProxy;
    final DataCallback<T> mDataCallback;
    int mDisplayedGeneration = 0;
    int mItemCount = 0;
    private final MainThreadCallback<T> mMainThreadCallback = new C08721();
    ...
    class C08721 implements MainThreadCallback<T> {
        C08721() {
        }
    ...
    class C08732 implements BackgroundCallback<T> {
        ...
        private void flushTileCache(int scrollHint) {
            ...
            while (this.mLoadedTiles.size() >= cacheSizeLimit) {
                ...
                int lastLoadedTileStart = this.mLoadedTiles;
                lastLoadedTileStart = lastLoadedTileStart.keyAt(lastLoadedTileStart.size() - 1);
