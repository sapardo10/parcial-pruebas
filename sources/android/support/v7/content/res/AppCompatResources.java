...
public final class AppCompatResources {
    ...
    private static android.content.res.ColorStateList getCachedColorStateList(@android.support.annotation.NonNull android.content.Context r5, @android.support.annotation.ColorRes int r6) {
        ...
        monitor-enter(r0);
        r1 = sColorStateCaches;	 Catch:{ all -> 0x0038 }
        r1 = r1.get(r5);	 Catch:{ all -> 0x0038 }
        r1 = (android.util.SparseArray) r1;	 Catch:{ all -> 0x0038 }
        if (r1 == 0) goto L_0x0034;
    L_0x000d:
        r2 = r1.size();	 Catch:{ all -> 0x0038 }
        if (r2 <= 0) goto L_0x0034;
    L_0x0013:
        r2 = r1.get(r6);	 Catch:{ all -> 0x0038 }
        r2 = (android.support.v7.content.res.AppCompatResources.ColorStateListCacheEntry) r2;	 Catch:{ all -> 0x0038 }
        if (r2 == 0) goto L_0x0033;
    L_0x001b:
        r3 = r2.configuration;	 Catch:{ all -> 0x0038 }
        r4 = r5.getResources();	 Catch:{ all -> 0x0038 }
        r4 = r4.getConfiguration();	 Catch:{ all -> 0x0038 }
        r3 = r3.equals(r4);	 Catch:{ all -> 0x0038 }
        if (r3 == 0) goto L_0x002f;
    L_0x002b:
        r3 = r2.value;	 Catch:{ all -> 0x0038 }
        monitor-exit(r0);	 Catch:{ all -> 0x0038 }
        return r3;
    L_0x002f:
        r1.remove(r6);	 Catch:{ all -> 0x0038 }
        goto L_0x0035;
    L_0x0033:
        goto L_0x0035;
    L_0x0035:
