        ...
        if (newList != countRemoved) {
            ...
            if (newList == null) {
                ...
                this.mConfig.getBackgroundThreadExecutor().execute(new Runnable() {
                    ...
                    public void run() {
                        final DiffResult result = DiffUtil.calculateDiff(new C08711());
