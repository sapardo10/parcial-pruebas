...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C03401 extends DataSetObserver {
        C03401() {
        }
    ...
    class C03412 implements OnGlobalLayoutListener {
        C03412() {
        }
    ...
    class C03423 extends AccessibilityDelegate {
        C03423() {
        }
    ...
    class C03435 extends DataSetObserver {
        C03435() {
        }
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            switch (getItemViewType(position)) {
                case 0:
                    ...
                    if (convertView != null) {
                        if (convertView.getId() == C0286R.id.list_item) {
                            packageManager = ActivityChooserView.this.getContext().getPackageManager();
                            activity = (ResolveInfo) getItem(position);
                            ((ImageView) convertView.findViewById(C0286R.id.icon)).setImageDrawable(activity.loadIcon(packageManager));
                            ((TextView) convertView.findViewById(C0286R.id.title)).setText(activity.loadLabel(packageManager));
                    ...
                    convertView = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0286R.layout.abc_activity_chooser_view_list_item, parent, false);
                    packageManager = ActivityChooserView.this.getContext().getPackageManager();
                    activity = (ResolveInfo) getItem(position);
                    ((ImageView) convertView.findViewById(C0286R.id.icon)).setImageDrawable(activity.loadIcon(packageManager));
                    ((TextView) convertView.findViewById(C0286R.id.title)).setText(activity.loadLabel(packageManager));
                ...
                case 1:
                    ...
                    convertView = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0286R.layout.abc_activity_chooser_view_list_item, parent, false);
                    convertView.setId(1);
                    ((TextView) convertView.findViewById(C0286R.id.title)).setText(ActivityChooserView.this.getContext().getString(C0286R.string.abc_activity_chooser_view_see_all));
                    return convertView;
                default:
                    throw new IllegalArgumentException();
            }
        ...
        public void setShowDefaultActivity(boolean showDefaultActivity, boolean highlightDefaultActivity) {
            if (this.mShowDefaultActivity == showDefaultActivity) {
                if (this.mHighlightDefaultActivity == highlightDefaultActivity) {
                    return;
                }
            }
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mModelDataSetObserver = new C03401();
        this.mOnGlobalLayoutListener = new C03412();
        this.mInitialActivityCount = 4;
        TypedArray attributesArray = context.obtainStyledAttributes(attrs, C0286R.styleable.ActivityChooserView, defStyle, 0);
        this.mInitialActivityCount = attributesArray.getInt(C0286R.styleable.ActivityChooserView_initialActivityCount, 4);
        Drawable expandActivityOverflowButtonDrawable = attributesArray.getDrawable(C0286R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        attributesArray.recycle();
        LayoutInflater.from(getContext()).inflate(C0286R.layout.abc_activity_chooser_view, this, true);
        this.mCallbacks = new Callbacks();
        this.mActivityChooserContent = findViewById(C0286R.id.activity_chooser_view_content);
        this.mActivityChooserContentBackground = this.mActivityChooserContent.getBackground();
        this.mDefaultActivityButton = (FrameLayout) findViewById(C0286R.id.default_activity_button);
        this.mDefaultActivityButton.setOnClickListener(this.mCallbacks);
        this.mDefaultActivityButton.setOnLongClickListener(this.mCallbacks);
        this.mDefaultActivityButtonImage = (ImageView) this.mDefaultActivityButton.findViewById(C0286R.id.image);
        FrameLayout expandButton = (FrameLayout) findViewById(C0286R.id.expand_activities_button);
        expandButton.setOnClickListener(this.mCallbacks);
        expandButton.setAccessibilityDelegate(new C03423());
        ...
        this.mExpandActivityOverflowButtonImage = (ImageView) expandButton.findViewById(C0286R.id.image);
        ...
        this.mAdapter.registerDataSetObserver(new C03435());
        Resources resources = context.getResources();
        this.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0286R.dimen.abc_config_prefDialogWidth));
    }
            ...
            if (!popupWindow.isShowing()) {
                ...
                if (!this.mIsSelectingDefaultActivity) {
                    if (defaultActivityButtonShown) {
                        ...
                        popupWindow.getListView().setContentDescription(getContext().getString(C0286R.string.abc_activitychooserview_choose_application));
