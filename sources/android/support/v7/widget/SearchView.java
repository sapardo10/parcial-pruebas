...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C03713 implements OnFocusChangeListener {
        C03713() {
        }
    ...
    class C03724 implements OnLayoutChangeListener {
        C03724() {
        }
    ...
    class C03746 implements OnKeyListener {
        C03746() {
        }
        ...
        public boolean onKey(View v, int keyCode, KeyEvent event) {
            ...
            if (SearchView.this.mSearchSrcTextView.isPopupShowing()) {
                if (SearchView.this.mSearchSrcTextView.getListSelection() != -1) {
    ...
    class C03757 implements OnEditorActionListener {
        C03757() {
        }
    ...
    class C03768 implements OnItemClickListener {
        C03768() {
        }
    ...
    class C03779 implements OnItemSelectedListener {
        C03779() {
        }
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C03781();
        boolean isIconified;

        /* renamed from: android.support.v7.widget.SearchView$SavedState$1 */
        static class C03781 implements ClassLoaderCreator<SavedState> {
            C03781() {
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0286R.attr.autoCompleteTextViewStyle);
        }

        public SearchAutoComplete(Context context, AttributeSet attrs, int defStyle) {
            super(context, attrs, defStyle);
            this.mRunShowSoftInputIfNecessary = new C03791();
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0286R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mUpdateDrawableStateRunnable = new C03691();
        this.mReleaseCursorRunnable = new C03702();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C03735();
        this.mTextKeyListener = new C03746();
        this.mOnEditorActionListener = new C03757();
        this.mOnItemClickListener = new C03768();
        this.mOnItemSelectedListener = new C03779();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0286R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0286R.styleable.SearchView_layout, C0286R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0286R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0286R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0286R.id.search_plate);
        this.mSubmitArea = findViewById(C0286R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0286R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0286R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0286R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0286R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0286R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C0286R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C0286R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0286R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0286R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0286R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0286R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0286R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0286R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0286R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = a.getResourceId(C0286R.styleable.SearchView_suggestionRowLayout, C0286R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0286R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C03713());
        setIconifiedByDefault(a.getBoolean(C0286R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0286R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0286R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0286R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0286R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0286R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0286R.styleable.SearchView_android_focusable, true));
        a.recycle();
        this.mVoiceWebSearchIntent = new Intent("android.speech.action.WEB_SEARCH");
        this.mVoiceWebSearchIntent.addFlags(C0555C.ENCODING_PCM_MU_LAW);
        this.mVoiceWebSearchIntent.putExtra("android.speech.extra.LANGUAGE_MODEL", "web_search");
        this.mVoiceAppSearchIntent = new Intent("android.speech.action.RECOGNIZE_SPEECH");
        this.mVoiceAppSearchIntent.addFlags(C0555C.ENCODING_PCM_MU_LAW);
        this.mDropDownAnchor = findViewById(this.mSearchSrcTextView.getDropDownAnchor());
        View view = this.mDropDownAnchor;
        if (view != null) {
            view.addOnLayoutChangeListener(new C03724());
        }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0286R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0286R.dimen.abc_search_view_preferred_height);
    }
    ...
    void onSubmitQuery() {
        ...
        if (query != null && TextUtils.getTrimmedLength(query) > 0) {
            ...
            if (onQueryTextListener != null) {
                if (onQueryTextListener.onQueryTextSubmit(query.toString())) {
                    return;
                }
            }
            if (this.mSearchable != null) {
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0286R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0286R.dimen.abc_dropdownitem_text_padding_left) : 0;
    ...
    boolean onItemClicked(int position, int actionKey, String actionMsg) {
        ...
        if (onSuggestionListener != null) {
            if (onSuggestionListener.onSuggestionClick(position)) {
                return false;
            }
        }
    ...
    boolean onItemSelected(int position) {
        OnSuggestionListener onSuggestionListener = this.mOnSuggestionListener;
        if (onSuggestionListener != null) {
            if (onSuggestionListener.onSuggestionSelect(position)) {
                return false;
            }
        }
    ...
    private Intent createIntent(String action, Uri data, String extraData, String query, int actionKey, String actionMsg) {
        ...
        intent.addFlags(C0555C.ENCODING_PCM_MU_LAW);
        if (data != null) {
            intent.setData(data);
        }
    ...
    private Intent createVoiceAppSearchIntent(Intent baseIntent, SearchableInfo searchable) {
        ...
        if (parcelable != null) {
            queryExtras.putParcelable("app_data", parcelable);
        }
        Intent voiceIntent = new Intent(baseIntent);
