...
class ActionMenuPresenter extends BaseMenuPresenter implements SubUiVisibilityListener {
    ...
    private class ActionButtonSubmenu extends MenuPopupHelper {
        public ActionButtonSubmenu(Context context, SubMenuBuilder subMenu, View anchorView) {
            super(context, subMenu, anchorView, false, C0286R.attr.actionOverflowMenuStyle);
    ...
    private class OverflowMenuButton extends AppCompatImageView implements ActionMenuChildView {
        ...
        public OverflowMenuButton(Context context) {
            super(context, null, C0286R.attr.actionOverflowButtonStyle);
            setClickable(true);
            setFocusable(true);
            setVisibility(0);
            setEnabled(true);
    ...
    private class OverflowPopup extends MenuPopupHelper {
        public OverflowPopup(Context context, MenuBuilder menu, View anchorView, boolean overflowOnly) {
            super(context, menu, anchorView, overflowOnly, C0286R.attr.actionOverflowMenuStyle);
    ...
    public ActionMenuPresenter(Context context) {
        super(context, C0286R.layout.abc_action_menu_layout, C0286R.layout.abc_action_menu_item_layout);
    }
    ...
    public View getItemView(MenuItemImpl item, View convertView, ViewGroup parent) {
        ...
        if (actionView != null) {
            if (!item.hasCollapsibleActionView()) {
    ...
    private View findViewForItem(MenuItem item) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child instanceof ItemView) {
                if (((ItemView) child).getItemData() == item) {
                    return child;
                }
            }
        }
