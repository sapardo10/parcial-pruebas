...
class TooltipPopup {
    ...
    TooltipPopup(Context context) {
        ...
        this.mContentView = LayoutInflater.from(this.mContext).inflate(C0286R.layout.abc_tooltip, null);
        this.mMessageView = (TextView) this.mContentView.findViewById(C0286R.id.message);
        ...
        layoutParams.windowAnimations = C0286R.style.Animation_AppCompat_Tooltip;
    ...
    private void computePosition(View anchorView, int anchorX, int anchorY, boolean fromTouch, LayoutParams outParams) {
        ...
        int tooltipPreciseAnchorThreshold = this.mContext.getResources().getDimensionPixelOffset(C0286R.dimen.tooltip_precise_anchor_threshold);
        ...
        if (anchorView.getHeight() >= tooltipPreciseAnchorThreshold) {
            offsetAbove = r0.mContext.getResources().getDimensionPixelOffset(C0286R.dimen.tooltip_precise_anchor_extra_offset);
        ...
        int tooltipOffset = r0.mContext.getResources().getDimensionPixelOffset(fromTouch ? C0286R.dimen.tooltip_y_offset_touch : C0286R.dimen.tooltip_y_offset_non_touch);
