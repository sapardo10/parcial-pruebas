...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    static final Interpolator sQuinticInterpolator = new C03663();
    ...
    static class C03663 implements Interpolator {
        C03663() {
        }
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C09021();
        ...
        private final Callback mVerticalBoundCheckCallback = new C09032();
        private int mWidth;
        ...
        class C09021 implements Callback {
            C09021() {
            }
        ...
        class C09032 implements Callback {
            C09032() {
            }
        ...
        public void startSmoothScroll(SmoothScroller smoothScroller) {
            ...
            if (smoothScroller2 != null && smoothScroller != smoothScroller2) {
        ...
        private void scrapOrRecycleView(Recycler recycler, int index, View view) {
            ...
            if (!viewHolder.shouldIgnore()) {
                if (viewHolder.isInvalid() && !viewHolder.isRemoved()) {
                    if (!this.mRecyclerView.mAdapter.hasStableIds()) {
                        removeViewAt(index);
        ...
        boolean shouldReMeasureChild(View child, int widthSpec, int heightSpec, LayoutParams lp) {
            if (this.mMeasurementCacheEnabled) {
                if (isMeasurementUpToDate(child.getMeasuredWidth(), widthSpec, lp.width)) {
        ...
        boolean shouldMeasureChild(View child, int widthSpec, int heightSpec, LayoutParams lp) {
            if (!child.isLayoutRequested() && this.mMeasurementCacheEnabled) {
                if (isMeasurementUpToDate(child.getWidth(), widthSpec, lp.width)) {
        ...
        private int[] getChildRectangleOnScreenScrollAmount(RecyclerView parent, View child, Rect rect, boolean immediate) {
            ...
            if (getLayoutDirection() == 1) {
                ...
                i = Math.min(childLeft - parentLeft, offScreenRight);
            }
            if (offScreenTop != 0) {
                dy = offScreenTop;
            } else {
        ...
        public boolean requestChildRectangleOnScreen(RecyclerView parent, View child, Rect rect, boolean immediate, boolean focusedChildVisible) {
            ...
            if (focusedChildVisible) {
                if (!isFocusedChildVisibleAfterScrolling(parent, dx, dy)) {
                    return false;
                }
            }
            if (dx == 0) {
        ...
        public boolean isViewPartiallyVisible(@NonNull View child, boolean completelyVisible, boolean acceptEndPointInclusion) {
            ...
            if (this.mHorizontalBoundCheck.isViewWithinBoundFlags(child, 24579)) {
                if (this.mVerticalBoundCheck.isViewWithinBoundFlags(child, 24579)) {
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0321R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0321R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0321R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0321R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0321R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    public final class Recycler {
        ...
        void recycleViewHolderInternal(android.support.v7.widget.RecyclerView.ViewHolder r11) {
            /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:70:0x0136 in {4, 14, 15, 16, 17, 22, 23, 31, 32, 42, 43, 44, 45, 46, 47, 48, 49, 50, 52, 53, 58, 59, 60, 62, 64, 67, 69} preds:[]
...
*/
        ...
        L_0x0066:
            r1 = r6;
            r7 = android.support.v7.widget.RecyclerView.ALLOW_THREAD_GAP_WORK;
        ...
        L_0x007f:
            r8 = r10.mCachedViews;
            r8 = r8.get(r7);
            r8 = (android.support.v7.widget.RecyclerView.ViewHolder) r8;
            r8 = r8.mPosition;
        ...
        boolean validateViewHolderForOffsetPosition(ViewHolder holder) {
            ...
            if (!RecyclerView.this.mState.isPreLayout()) {
                if (RecyclerView.this.mAdapter.getItemViewType(holder.mPosition) != holder.getItemViewType()) {
                    return false;
                }
            }
        ...
        private boolean tryBindViewHolderByDeadline(ViewHolder holder, int offsetPosition, int position, long deadlineNs) {
            ...
            if (deadlineNs != Long.MAX_VALUE) {
                if (!this.mRecyclerPool.willBindInTime(viewType, startBindNs, deadlineNs)) {
                    return false;
                }
            }
        ...
        ViewHolder tryGetViewHolderForPositionByDeadline(int position, boolean dryRun, long deadlineNs) {
            ...
            if (holder2 == null) {
                ...
                if (holder2 == null) {
                    View view = recycler.mViewCacheExtension;
                    if (view != null) {
                        view = view.getViewForPositionAndType(recycler, i, type);
                        if (view != null) {
                        ...
                        if (holder2 != null) {
                            start = RecyclerView.this.getNanoTime();
                            if (deadlineNs != Long.MAX_VALUE) {
                                if (!recycler.mRecyclerPool.willCreateInTime(type, start, deadlineNs)) {
                                    return null;
                                }
                            }
                            holder2 = RecyclerView.this.mAdapter.createViewHolder(RecyclerView.this, type);
                            if (RecyclerView.ALLOW_THREAD_GAP_WORK) {
                                innerView = RecyclerView.findNestedRecyclerView(holder2.itemView);
                                if (innerView != null) {
            ...
            if (fromScrapOrHiddenOrCache && !RecyclerView.this.mState.isPreLayout()) {
                if (holder.hasAnyOfTheFlags(8192)) {
        ...
        ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int position, boolean dryRun) {
            ...
            for (i = 0; i < scrapCount; i++) {
                ...
                if (!holder.wasReturnedFromScrap() && holder.getLayoutPosition() == position) {
                    if (!holder.isInvalid() && (RecyclerView.this.mState.mInPreLayout || !holder.isRemoved())) {
                        holder.addFlags(32);
                        return holder;
                    }
                }
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                if (RecyclerView.this.dispatchNestedScroll(hresult, adapterSize, overscrollX, overscrollY, null, 1)) {
                    ...
                    if (overscrollX != x) {
                        i = overscrollX < 0 ? -vel : overscrollX > 0 ? vel : 0;
                    } else {
                        i = 0;
                    }
                    if (overscrollY != y) {
                        i2 = overscrollY < 0 ? -vel : overscrollY > 0 ? vel : 0;
                    } else {
                        i2 = 0;
                    }
                    if (RecyclerView.this.getOverScrollMode() != 2) {
                    ...
                    if (i == 0 && overscrollX != x) {
                        if (scroller.getFinalX() == 0) {
                        }
                    }
                    if (i2 == 0 && overscrollY != y) {
                ...
                if (hresult == 0) {
                    if (adapterSize == 0) {
                        ...
                        fullyConsumedVertical = dy == 0 && RecyclerView.this.mLayout.canScrollVertically() && adapterSize == dy;
                        fullyConsumedHorizontal = dx == 0 && RecyclerView.this.mLayout.canScrollHorizontally() && hresult == dx;
                        if (!((dx == 0 && dy == 0) || fullyConsumedHorizontal)) {
                            if (fullyConsumedVertical) {
                                fullyConsumedAny = false;
                                if (scroller.isFinished()) {
                                    if (fullyConsumedAny) {
                                        if (RecyclerView.this.hasNestedScrollingParent(1)) {
                                        }
                                    }
                                    postOnAnimation();
    ...
    class C08994 implements ProcessCallback {
        C08994() {
        }
    ...
    class C09005 implements Callback {
        C09005() {
        }
    ...
    class C09016 implements Callback {
        C09016() {
        }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C03641();
        ...
        r6.mItemAnimatorRunner = new C03652();
        r6.mViewInfoProcessCallback = new C08994();
        ...
        if (attributeSet != null) {
            TypedArray a2 = context2.obtainStyledAttributes(attributeSet, C0321R.styleable.RecyclerView, i, 0);
            String layoutManagerName = a2.getString(C0321R.styleable.RecyclerView_layoutManager);
            int descendantFocusability = a2.getInt(C0321R.styleable.RecyclerView_android_descendantFocusability, -1);
            if (descendantFocusability == -1) {
                setDescendantFocusability(262144);
            }
            r6.mEnableFastScroller = a2.getBoolean(C0321R.styleable.RecyclerView_fastScrollEnabled, false);
            if (r6.mEnableFastScroller) {
                initFastScroller((StateListDrawable) a2.getDrawable(C0321R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a2.getDrawable(C0321R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a2.getDrawable(C0321R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a2.getDrawable(C0321R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            a2.recycle();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C09005());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C09016());
    }
            ...
            if (!this.mDataSetHasChangedAfterLayout) {
                if (this.mAdapterHelper.hasPendingUpdates()) {
                    if (this.mAdapterHelper.hasAnyUpdateTypes(4)) {
                        if (!this.mAdapterHelper.hasAnyUpdateTypes(11)) {
    ...
    boolean scrollByInternal(int x, int y, MotionEvent ev) {
        ...
        if (this.mAdapter != null) {
            ...
            if (i != 0) {
                consumedX2 = r7.mLayout.scrollHorizontallyBy(i, r7.mRecycler, r7.mState);
                unconsumedX2 = i - consumedX2;
            }
            if (i2 != 0) {
                consumedY2 = r7.mLayout.scrollVerticallyBy(i2, r7.mRecycler, r7.mState);
        ...
        if (dispatchNestedScroll(consumedX, consumedY, unconsumedX, unconsumedY, r7.mScrollOffset, 0)) {
            unconsumedX2 = r7.mLastTouchX;
            int[] iArr = r7.mScrollOffset;
            r7.mLastTouchX = unconsumedX2 - iArr[0];
            r7.mLastTouchY -= iArr[1];
            if (motionEvent != null) {
                motionEvent.offsetLocation((float) iArr[0], (float) iArr[1]);
            }
            int[] iArr2 = r7.mNestedOffsets;
            consumedX2 = iArr2[0];
            int[] iArr3 = r7.mScrollOffset;
            iArr2[0] = consumedX2 + iArr3[0];
    ...
    public void addFocusables(ArrayList<View> views, int direction, int focusableMode) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager != null) {
            if (layoutManager.onAddFocusables(this, views, direction, focusableMode)) {
                return;
            }
        }
    ...
    private boolean dispatchOnItemTouchIntercept(MotionEvent e) {
        ...
        if (action != 3) {
            if (action != 0) {
                listenerCount = this.mOnItemTouchListeners.size();
                while (i < listenerCount) {
                    listener = (OnItemTouchListener) this.mOnItemTouchListeners.get(i);
                    ...
                    case 2:
                        ...
                        if (index >= 0) {
                            ...
                            if (dispatchNestedPreScroll(dx, dy, r6.mScrollConsumed, r6.mScrollOffset, 0)) {
                                iArr = r6.mScrollConsumed;
                                dx -= iArr[0];
                                dy -= iArr[1];
                                iArr = r6.mScrollOffset;
                                vtev.offsetLocation((float) iArr[0], (float) iArr[1]);
                                iArr = r6.mNestedOffsets;
                                x = iArr[0];
                            ...
                            if (r6.mScrollState == 1) {
                                iArr2 = r6.mScrollOffset;
                                r6.mLastTouchX = x3 - iArr2[0];
                                r6.mLastTouchY = y3 - iArr2[1];
                                i2 = canScrollHorizontally ? y : 0;
                                if (canScrollVertically) {
                                    i = x;
                                }
    ...
    private void processAdapterUpdatesAndSetAnimationFlags() {
        ...
        if (!this.mItemsAddedOrRemoved) {
            if (!this.mItemsChanged) {
                ...
                state = this.mState;
                if (!this.mFirstLayoutComplete && this.mItemAnimator != null && (this.mDataSetHasChangedAfterLayout || animationTypeSupported || this.mLayout.mRequestedSimpleAnimations)) {
                    if (this.mDataSetHasChangedAfterLayout) {
                    ...
                    state = this.mState;
                    if (!state.mRunSimpleAnimations && animationTypeSupported && !this.mDataSetHasChangedAfterLayout) {
                        if (predictiveItemAnimationsEnabled()) {
                            z2 = true;
            ...
            for (i = 0; i < count; i++) {
                ...
                if (!holder.shouldIgnore()) {
                    if (!holder.isInvalid() || this.mAdapter.hasStableIds()) {
                        ...
                        if (this.mState.mTrackOldChangeHolders && holder.isUpdated() && !holder.isRemoved()) {
    ...
    private void dispatchLayoutStep3() {
        ...
        state.mLayoutStep = 1;
        if (state.mRunSimpleAnimations) {
            for (int i = r7.mChildHelper.getChildCount() - 1; i >= 0; i--) {
                ViewHolder holder = getChildViewHolderInt(r7.mChildHelper.getChildAt(i));
                if (!holder.shouldIgnore()) {
        ...
        if (r7.mLayout.mPrefetchMaxObservedInInitialPrefetch) {
            LayoutManager layoutManager = r7.mLayout;
        ...
        int[] iArr = r7.mMinMaxLayoutPositions;
    ...
    private boolean didChildRangeChange(int minPositionPreLayout, int maxPositionPreLayout) {
        ...
        if (iArr[0] == minPositionPreLayout) {
            if (iArr[1] == maxPositionPreLayout) {
                return false;
            }
        }
        return true;
    ...
    public void draw(Canvas c) {
        ...
        if (edgeEffect != null && !edgeEffect.isFinished()) {
            ...
            boolean z = edgeEffect2 != null && edgeEffect2.draw(c);
            needsInvalidate = z;
        ...
        if (edgeEffect != null && !edgeEffect.isFinished()) {
            ...
            padding = (edgeEffect3 == null || !edgeEffect3.draw(c)) ? 0 : 1;
        ...
        if (edgeEffect != null && !edgeEffect.isFinished()) {
            ...
            if (edgeEffect3 == null || !edgeEffect3.draw(c)) {
                i2 = 0;
            }
            needsInvalidate |= i2;
            c.restoreToCount(restore);
        }
        if (!needsInvalidate && this.mItemAnimator != null && this.mItemDecorations.size() > 0) {
    ...
    boolean canReuseUpdatedViewHolder(ViewHolder viewHolder) {
        ItemAnimator itemAnimator = this.mItemAnimator;
        if (itemAnimator != null) {
            if (!itemAnimator.canReuseUpdatedViewHolder(viewHolder, viewHolder.getUnmodifiedPayloads())) {
                return false;
            }
        }
        return true;
    ...
    public ViewHolder findViewHolderForAdapterPosition(int position) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (holder != null && !holder.isRemoved()) {
                if (getAdapterPositionFor(holder) == position) {
    ...
    public View findChildViewUnder(float x, float y) {
        for (int i = this.mChildHelper.getChildCount() - 1; i >= 0; i--) {
            ...
            if (x >= ((float) child.getLeft()) + translationX) {
                if (x <= ((float) child.getRight()) + translationX) {
                    if (y >= ((float) child.getTop()) + translationY) {
                        if (y <= ((float) child.getBottom()) + translationY) {
                            return child;
                        }
                    }
                }
    ...
    void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        FastScroller fastScroller = new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C0321R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0321R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0321R.dimen.fastscroll_margin));
    }
