...
class ViewBoundsCheck {
    ...
    static class BoundFlags {
        ...
        boolean boundsMatch() {
            ...
            if ((i & 7) != 0) {
                if ((i & (compare(this.mChildStart, this.mRvStart) << 0)) == 0) {
                    return false;
                }
            }
            i = this.mBoundFlags;
            if ((i & 112) != 0) {
                if ((i & (compare(this.mChildStart, this.mRvEnd) << 4)) == 0) {
                    return false;
                }
            }
            i = this.mBoundFlags;
            if ((i & 1792) != 0) {
                if ((i & (compare(this.mChildEnd, this.mRvStart) << 8)) == 0) {
                    return false;
                }
            }
            i = this.mBoundFlags;
            if ((i & 28672) != 0) {
                if ((i & (compare(this.mChildEnd, this.mRvEnd) << 12)) == 0) {
                    return false;
                }
            }
            return true;
