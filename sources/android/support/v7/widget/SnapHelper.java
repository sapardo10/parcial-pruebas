...
public abstract class SnapHelper extends OnFlingListener {
    ...
    private final OnScrollListener mScrollListener = new C09041();

    /* renamed from: android.support.v7.widget.SnapHelper$1 */
    class C09041 extends OnScrollListener {
    ...
    void snapToTargetExistingView() {
        LayoutManager layoutManager = this.mRecyclerView;
            ...
            return new LinearSmoothScroller(this.mRecyclerView.getContext()) {
                protected void onTargetFound(View targetView, State state, Action action) {
                    if (SnapHelper.this.mRecyclerView != null) {
                        int[] snapDistances = SnapHelper.this;
                        snapDistances = snapDistances.calculateDistanceToFinalSnap(snapDistances.mRecyclerView.getLayoutManager(), targetView);
