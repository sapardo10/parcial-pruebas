...
public class SwitchCompat extends CompoundButton {
    ...
    public SwitchCompat(Context context, AttributeSet attrs) {
        this(context, attrs, C0286R.attr.switchStyle);
    }
    ...
    public SwitchCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0286R.styleable.SwitchCompat, defStyleAttr, 0);
        this.mThumbDrawable = a.getDrawable(C0286R.styleable.SwitchCompat_android_thumb);
        Drawable drawable = this.mThumbDrawable;
        if (drawable != null) {
            drawable.setCallback(this);
        }
        this.mTrackDrawable = a.getDrawable(C0286R.styleable.SwitchCompat_track);
        drawable = this.mTrackDrawable;
        if (drawable != null) {
            drawable.setCallback(this);
        }
        this.mTextOn = a.getText(C0286R.styleable.SwitchCompat_android_textOn);
        this.mTextOff = a.getText(C0286R.styleable.SwitchCompat_android_textOff);
        this.mShowText = a.getBoolean(C0286R.styleable.SwitchCompat_showText, true);
        this.mThumbTextPadding = a.getDimensionPixelSize(C0286R.styleable.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = a.getDimensionPixelSize(C0286R.styleable.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = a.getDimensionPixelSize(C0286R.styleable.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = a.getBoolean(C0286R.styleable.SwitchCompat_splitTrack, false);
        ColorStateList thumbTintList = a.getColorStateList(C0286R.styleable.SwitchCompat_thumbTint);
        if (thumbTintList != null) {
            this.mThumbTintList = thumbTintList;
            this.mHasThumbTint = true;
        }
        Mode thumbTintMode = DrawableUtils.parseTintMode(a.getInt(C0286R.styleable.SwitchCompat_thumbTintMode, -1), null);
        ...
        if (!this.mHasThumbTint) {
            if (!this.mHasThumbTintMode) {
                trackTintList = a.getColorStateList(C0286R.styleable.SwitchCompat_trackTint);
                if (trackTintList != null) {
                    this.mTrackTintList = trackTintList;
                    this.mHasTrackTint = true;
                }
                trackTintMode = DrawableUtils.parseTintMode(a.getInt(C0286R.styleable.SwitchCompat_trackTintMode, -1), null);
                ...
                if (!this.mHasTrackTint) {
                    if (this.mHasTrackTintMode) {
                        appearance = a.getResourceId(C0286R.styleable.SwitchCompat_switchTextAppearance, 0);
                        if (appearance == 0) {
    ...
    public void setSwitchTextAppearance(Context context, int resid) {
        TintTypedArray appearance = TintTypedArray.obtainStyledAttributes(context, resid, C0286R.styleable.TextAppearance);
        ColorStateList colors = appearance.getColorStateList(C0286R.styleable.TextAppearance_android_textColor);
        if (colors != null) {
            this.mTextColors = colors;
        } else {
            this.mTextColors = getTextColors();
        }
        int ts = appearance.getDimensionPixelSize(C0286R.styleable.TextAppearance_android_textSize, 0);
        if (ts != 0) {
        ...
        setSwitchTypefaceByIndex(appearance.getInt(C0286R.styleable.TextAppearance_android_typeface, -1), appearance.getInt(C0286R.styleable.TextAppearance_android_textStyle, -1));
        if (appearance.getBoolean(C0286R.styleable.TextAppearance_textAllCaps, false)) {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Rect inset = this.mThumbDrawable;
        if (inset != null) {
            inset = DrawableUtils.getOpticalBounds(inset);
    ...
    private Layout makeLayout(CharSequence text) {
        ...
        TextPaint textPaint = this.mTextPaint;
        return new StaticLayout(transformed, textPaint, transformed != null ? (int) Math.ceil((double) Layout.getDesiredWidth(transformed, textPaint)) : 0, Alignment.ALIGN_NORMAL, 1.0f, 0.0f, true);
    }
            ...
            case 2:
                ...
                switch (this.mTouchMode) {
                    ...
                    case 1:
                        y = ev.getX();
                        y2 = ev.getY();
                        if (Math.abs(y - this.mTouchX) <= ((float) this.mTouchSlop)) {
                            if (Math.abs(y2 - this.mTouchY) <= ((float) this.mTouchSlop)) {
                                break;
                            }
                        }
                        this.mTouchMode = 2;
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (gravity == 16) {
            ...
            gravity = paddingTop - (i / 2);
            switchBottom = gravity + i;
        } else if (gravity != 80) {
            switchBottom = getPaddingTop();
            gravity = switchBottom;
            switchBottom = this.mSwitchHeight + switchBottom;
        } else {
            gravity = 0;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (switchText != null) {
            ...
            ColorStateList colorStateList = r0.mTextColors;
            if (colorStateList != null) {
                r0.mTextPaint.setColor(colorStateList.getColorForState(drawableState, 0));
            }
    ...
    private int getThumbScrollRange() {
        ...
        if (drawable != null) {
            insets = DrawableUtils.getOpticalBounds(drawable);
        } else {
