...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View v) {
            ...
            this.mIconRefine = (ImageView) v.findViewById(C0286R.id.edit_query);
        }
    }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        ((ImageView) v.findViewById(C0286R.id.edit_query)).setImageResource(this.mCommitIconResId);
        return v;
    }
    ...
    private CharSequence formatUrl(CharSequence url) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0286R.attr.textColorSearchUrl, colorValue, true);
    ...
    private Drawable getIcon1(Cursor cursor) {
        String value = this.mIconName1Col;
        if (value == -1) {
            return null;
        }
        Drawable drawable = getDrawableFromResourceValue(cursor.getString(value));
        if (drawable != null) {
            return drawable;
        }
    ...
    private Drawable getIcon2(Cursor cursor) {
        String value = this.mIconName2Col;
        if (value == -1) {
            return null;
        }
        return getDrawableFromResourceValue(cursor.getString(value));
    }
    ...
    private Drawable getDrawable(Uri uri) {
        ...
        try {
            if ("android.resource".equals(uri.getScheme())) {
                drawable = getDrawableFromResourceUri(uri);
                return drawable;
            }
    ...
    Cursor getSearchManagerSuggestions(SearchableInfo searchable, String query, int limit) {
        ...
        String[] selArgs;
        Builder uriBuilder = new Builder().scheme(NSContent.NSTAG).authority(authority).query("").fragment("");
