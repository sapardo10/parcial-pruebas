...
public class ListPopupWindow implements ShowableListMenu {
    ...
    class C03623 implements OnItemSelectedListener {
        C03623() {
        }
    ...
    private class PopupTouchInterceptor implements OnTouchListener {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            if (action == 0 && ListPopupWindow.this.mPopup != null) {
                if (ListPopupWindow.this.mPopup.isShowing() && x >= 0) {
                    if (x < ListPopupWindow.this.mPopup.getWidth() && y >= 0 && y < ListPopupWindow.this.mPopup.getHeight()) {
    ...
    private class ResizePopupRunnable implements Runnable {
        ...
        public void run() {
            if (ListPopupWindow.this.mDropDownList != null && ViewCompat.isAttachedToWindow(ListPopupWindow.this.mDropDownList)) {
    ...
    public ListPopupWindow(@NonNull Context context) {
        this(context, null, C0286R.attr.listPopupWindowStyle);
    }

    public ListPopupWindow(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, C0286R.attr.listPopupWindowStyle);
    }
    ...
    public ListPopupWindow(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0286R.styleable.ListPopupWindow, defStyleAttr, defStyleRes);
        this.mDropDownHorizontalOffset = a.getDimensionPixelOffset(C0286R.styleable.ListPopupWindow_android_dropDownHorizontalOffset, 0);
        this.mDropDownVerticalOffset = a.getDimensionPixelOffset(C0286R.styleable.ListPopupWindow_android_dropDownVerticalOffset, 0);
    ...
    public void show() {
        ...
        if (!this.mPopup.isShowing()) {
            ...
            this.mPopup.update(getAnchorView(), this.mDropDownHorizontalOffset, this.mDropDownVerticalOffset, i < 0 ? -1 : i, heightSpec < 0 ? -1 : heightSpec);
        }
    }
    ...
    public boolean onKeyDown(int keyCode, @NonNull KeyEvent event) {
        if (isShowing()) {
            if (keyCode != 62) {
                ...
                if (below || keyCode != 20 || curIndex < lastItem) {
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mShowDropDownRunnable = new C03612();
            ...
            this.mDropDownList.setOnItemSelectedListener(new C03623());
        ...
        if (!this.mDropDownAlwaysVisible) {
            if (this.mDropDownHeight != -1) {
                ...
                switch (i) {
                    case -2:
                        i = MeasureSpec.makeMeasureSpec(this.mContext.getResources().getDisplayMetrics().widthPixels - (this.mTempRect.left + this.mTempRect.right), Integer.MIN_VALUE);
                        break;
                    case -1:
                        i = MeasureSpec.makeMeasureSpec(this.mContext.getResources().getDisplayMetrics().widthPixels - (this.mTempRect.left + this.mTempRect.right), 1073741824);
                        break;
                    default:
                        i = MeasureSpec.makeMeasureSpec(i, 1073741824);
                        break;
                }
                int listContent = this.mDropDownList.measureHeightOfChildrenCompat(i, 0, -1, maxHeight - otherHeights, -1);
                if (listContent > 0) {
