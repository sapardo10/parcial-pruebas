...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:74:0x0155 in {6, 7, 10, 11, 16, 17, 26, 27, 29, 30, 33, 34, 35, 36, 37, 42, 43, 46, 47, 50, 51, 54, 55, 56, 57, 64, 65, 66, 67, 68, 69, 71, 73} preds:[]
...
*/
    ...
    public ActionBarContextView(Context context, AttributeSet attrs) {
        this(context, attrs, C0286R.attr.actionModeStyle);
    }

    public ActionBarContextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0286R.styleable.ActionMode, defStyle, 0);
        ViewCompat.setBackground(this, a.getDrawable(C0286R.styleable.ActionMode_background));
        this.mTitleStyleRes = a.getResourceId(C0286R.styleable.ActionMode_titleTextStyle, 0);
        this.mSubtitleStyleRes = a.getResourceId(C0286R.styleable.ActionMode_subtitleTextStyle, 0);
        this.mContentHeight = a.getLayoutDimension(C0286R.styleable.ActionMode_height, 0);
        this.mCloseItemLayout = a.getResourceId(C0286R.styleable.ActionMode_closeItemLayout, C0286R.layout.abc_action_mode_close_item_material);
        a.recycle();
    }
    ...
    private void initTitle() {
        if (this.mTitleLayout == null) {
            LayoutInflater.from(getContext()).inflate(C0286R.layout.abc_action_bar_title_item, this);
            this.mTitleLayout = (LinearLayout) getChildAt(getChildCount() - 1);
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0286R.id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0286R.id.action_bar_subtitle);
    ...
    public void initForMode(final ActionMode mode) {
        ...
        if (view == null) {
            ...
            addView(this.mClose);
            this.mClose.findViewById(C0286R.id.action_mode_close_button).setOnClickListener(new OnClickListener() {
        ...
        this.mClose.findViewById(C0286R.id.action_mode_close_button).setOnClickListener(/* anonymous class already generated */);
        menu = (MenuBuilder) mode.getMenu();
        if (this.mActionMenuPresenter != null) {
            this.mActionMenuPresenter.dismissPopupMenus();
        }
