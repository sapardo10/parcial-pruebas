...
class TooltipCompatHandler implements OnLongClickListener, OnHoverListener, OnAttachStateChangeListener {
    ...
    private final Runnable mHideRunnable = new C03892();
    private TooltipPopup mPopup;
    private final Runnable mShowRunnable = new C03881();
    ...
    public static void setTooltipText(View view, CharSequence tooltipText) {
        ...
        tooltipCompatHandler = new TooltipCompatHandler(view, tooltipText);
    }
