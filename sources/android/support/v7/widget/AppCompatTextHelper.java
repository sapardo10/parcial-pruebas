...
class AppCompatTextHelper {
    ...
    void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0286R.styleable.AppCompatTextHelper, i, 0);
        int ap = a.getResourceId(C0286R.styleable.AppCompatTextHelper_android_textAppearance, -1);
        if (a.hasValue(C0286R.styleable.AppCompatTextHelper_android_drawableLeft)) {
            r0.mDrawableLeftTint = createTintInfo(context, drawableManager, a.getResourceId(C0286R.styleable.AppCompatTextHelper_android_drawableLeft, 0));
        }
        if (a.hasValue(C0286R.styleable.AppCompatTextHelper_android_drawableTop)) {
            r0.mDrawableTopTint = createTintInfo(context, drawableManager, a.getResourceId(C0286R.styleable.AppCompatTextHelper_android_drawableTop, 0));
        }
        if (a.hasValue(C0286R.styleable.AppCompatTextHelper_android_drawableRight)) {
            r0.mDrawableRightTint = createTintInfo(context, drawableManager, a.getResourceId(C0286R.styleable.AppCompatTextHelper_android_drawableRight, 0));
        }
        if (a.hasValue(C0286R.styleable.AppCompatTextHelper_android_drawableBottom)) {
            r0.mDrawableBottomTint = createTintInfo(context, drawableManager, a.getResourceId(C0286R.styleable.AppCompatTextHelper_android_drawableBottom, 0));
        }
        a.recycle();
        ...
        if (ap != -1) {
            a = TintTypedArray.obtainStyledAttributes(context, ap, C0286R.styleable.TextAppearance);
            if (!hasPwdTm && a.hasValue(C0286R.styleable.TextAppearance_textAllCaps)) {
                allCaps = a.getBoolean(C0286R.styleable.TextAppearance_textAllCaps, false);
                z = true;
            }
            updateTypefaceAndStyle(context, a);
            if (VERSION.SDK_INT < 23) {
                if (a.hasValue(C0286R.styleable.TextAppearance_android_textColor)) {
                    textColor = a.getColorStateList(C0286R.styleable.TextAppearance_android_textColor);
                }
                if (a.hasValue(C0286R.styleable.TextAppearance_android_textColorHint)) {
                    textColorHint = a.getColorStateList(C0286R.styleable.TextAppearance_android_textColorHint);
                }
                if (a.hasValue(C0286R.styleable.TextAppearance_android_textColorLink)) {
                    textColorLink = a.getColorStateList(C0286R.styleable.TextAppearance_android_textColorLink);
                }
            }
            a.recycle();
        }
        a = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0286R.styleable.TextAppearance, i, 0);
        if (!hasPwdTm && a.hasValue(C0286R.styleable.TextAppearance_textAllCaps)) {
            z = true;
            allCaps = a.getBoolean(C0286R.styleable.TextAppearance_textAllCaps, false);
        }
    ...
    private void updateTypefaceAndStyle(Context context, TintTypedArray a) {
        this.mStyle = a.getInt(C0286R.styleable.TextAppearance_android_textStyle, this.mStyle);
        boolean z = true;
        if (!a.hasValue(C0286R.styleable.TextAppearance_android_fontFamily)) {
            if (!a.hasValue(C0286R.styleable.TextAppearance_fontFamily)) {
                if (a.hasValue(C0286R.styleable.TextAppearance_android_typeface)) {
                    this.mAsyncFontPending = false;
                    switch (a.getInt(C0286R.styleable.TextAppearance_android_typeface, 1)) {
                        case 1:
        ...
        int fontFamilyId = a.hasValue(C0286R.styleable.TextAppearance_fontFamily) ? C0286R.styleable.TextAppearance_fontFamily : C0286R.styleable.TextAppearance_android_fontFamily;
    ...
    void onSetTextAppearance(Context context, int resId) {
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, resId, C0286R.styleable.TextAppearance);
        if (a.hasValue(C0286R.styleable.TextAppearance_textAllCaps)) {
            setAllCaps(a.getBoolean(C0286R.styleable.TextAppearance_textAllCaps, false));
        }
        if (VERSION.SDK_INT < 23) {
            if (a.hasValue(C0286R.styleable.TextAppearance_android_textColor)) {
                ColorStateList textColor = a.getColorStateList(C0286R.styleable.TextAppearance_android_textColor);
                if (textColor != null) {
