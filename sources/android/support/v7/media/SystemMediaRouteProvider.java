...
abstract class SystemMediaRouteProvider extends MediaRouteProvider {
    ...
    static class JellybeanImpl extends SystemMediaRouteProvider implements Callback, VolumeCallback {
        ...
        public JellybeanImpl(Context context, SyncCallback syncCallback) {
            ...
            this.mUserRouteCategoryObj = MediaRouterJellybean.createRouteCategory(this.mRouterObj, context.getResources().getString(C0299R.string.mr_user_route_category_name), false);
            updateSystemRoutes();
        }
        ...
        public void onDiscoveryRequestChanged(MediaRouteDiscoveryRequest request) {
            ...
            if (this.mRouteTypes == newRouteTypes) {
                if (this.mActiveScan == newActiveScan) {
                    return;
                }
            }
        ...
        private boolean addSystemRouteNoPublish(Object routeObj) {
            if (getUserRouteRecord(routeObj) == null) {
                if (findSystemRouteRecord(routeObj) < 0) {
        ...
        public void onRouteSelected(int type, Object routeObj) {
            if (routeObj == MediaRouterJellybean.getSelectedRoute(this.mRouterObj, 8388611)) {
                ...
                if (userRouteRecord != null) {
                    ...
                    int index = findSystemRouteRecord(routeObj);
                    if (index >= 0) {
                        this.mSyncCallback.onSystemRouteSelectedByDescriptorId(((SystemRouteRecord) this.mSystemRouteRecords.get(index)).mRouteDescriptorId);
                    }
                }
            }
        }
        ...
        public void onSyncRouteAdded(RouteInfo route) {
            ...
            if (((SystemRouteRecord) this.mSystemRouteRecords.get(index)).mRouteDescriptorId.equals(route.getDescriptorId())) {
                route.select();
            }
        }
    ...
    static class LegacyImpl extends SystemMediaRouteProvider {
        ...
        void publishRoutes() {
            ...
            setDescriptor(new MediaRouteProviderDescriptor.Builder().addRoute(new Builder(SystemMediaRouteProvider.DEFAULT_ROUTE_ID, r.getString(C0299R.string.mr_system_route_name)).addControlFilters(CONTROL_FILTERS).setPlaybackStream(3).setPlaybackType(0).setVolumeHandling(1).setVolumeMax(maxVolume).setVolume(this.mLastReportedVolume).build()).build());
        }
