...
public final class MediaRouteDiscoveryRequest {
    ...
    public boolean equals(Object o) {
        ...
        if (getSelector().equals(other.getSelector())) {
            if (isActiveScan() == other.isActiveScan()) {
                z = true;
                return z;
            }
        }
    ...
    public String toString() {
        ...
        result.append("DiscoveryRequest{ selector=");
        result.append(getSelector());
        result.append(", activeScan=");
        result.append(isActiveScan());
