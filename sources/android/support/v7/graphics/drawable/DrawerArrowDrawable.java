...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(null, C0286R.styleable.DrawerArrowToggle, C0286R.attr.drawerArrowStyle, C0286R.style.Base_Widget_AppCompat_DrawerArrowToggle);
        setColor(a.getColor(C0286R.styleable.DrawerArrowToggle_color, 0));
        setBarThickness(a.getDimension(C0286R.styleable.DrawerArrowToggle_thickness, 0.0f));
        setSpinEnabled(a.getBoolean(C0286R.styleable.DrawerArrowToggle_spinBars, true));
        setGapSize((float) Math.round(a.getDimension(C0286R.styleable.DrawerArrowToggle_gapBetweenBars, 0.0f)));
        this.mSize = a.getDimensionPixelSize(C0286R.styleable.DrawerArrowToggle_drawableSize, 0);
        this.mBarLength = (float) Math.round(a.getDimension(C0286R.styleable.DrawerArrowToggle_barLength, 0.0f));
        this.mArrowHeadLength = (float) Math.round(a.getDimension(C0286R.styleable.DrawerArrowToggle_arrowHeadLength, 0.0f));
        this.mArrowShaftLength = a.getDimension(C0286R.styleable.DrawerArrowToggle_arrowShaftLength, 0.0f);
        a.recycle();
    }
    ...
    public void draw(Canvas canvas) {
        ...
        double d = (double) f;
        float canvasRotate = lerp(flipToPointRight ? 0.0f : -180.0f, flipToPointRight ? 180.0f : 0.0f, r0.mProgress);
        ...
        Double.isNaN(d);
        float arrowHeight = (float) Math.round(d * sin);
        r0.mPath.rewind();
        ...
        if (r0.mSpin) {
            canvas2.rotate(((float) ((r0.mVerticalMirror ^ flipToPointRight) != 0 ? -1 : 1)) * canvasRotate);
