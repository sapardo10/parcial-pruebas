...
public final class TuplesKt {
    ...
    public static final <T> List<T> toList(@NotNull Pair<? extends T, ? extends T> $receiver) {
        ...
        return CollectionsKt.listOf(new Object[]{$receiver.getFirst(), $receiver.getSecond()});
    }

    @NotNull
    public static final <T> List<T> toList(@NotNull Triple<? extends T, ? extends T, ? extends T> $receiver) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
        return CollectionsKt.listOf(new Object[]{$receiver.getFirst(), $receiver.getSecond(), $receiver.getThird()});
    }
}
