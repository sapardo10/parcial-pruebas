...
class CollectionsKt___CollectionsJvmKt extends CollectionsKt__ReversedViewsKt {
    ...
    public static final <T extends Comparable<? super T>> SortedSet<T> toSortedSet(@NotNull Iterable<? extends T> $receiver) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
        return (SortedSet) CollectionsKt___CollectionsKt.toCollection($receiver, new TreeSet());
    }
    ...
    public static final <T> SortedSet<T> toSortedSet(@NotNull Iterable<? extends T> $receiver, @NotNull Comparator<? super T> comparator) {
        ...
        return (SortedSet) CollectionsKt___CollectionsKt.toCollection($receiver, new TreeSet(comparator));
    }
}
