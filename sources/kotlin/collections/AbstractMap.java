...
public abstract class AbstractMap<K, V> implements Map<K, V>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final String entryToString$kotlin_stdlib(@NotNull Entry<?, ?> e) {
            ...
            stringBuilder.append($receiver.getKey());
            stringBuilder.append('=');
            stringBuilder.append($receiver.getValue());
    ...
    public boolean containsValue(Object value) {
        ...
        for (Entry it : $receiver$iv) {
            if (Intrinsics.areEqual(it.getValue(), value) != null) {
                return true;
            }
        }
        return false;
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!($receiver$iv instanceof Collection) || !((Collection) $receiver$iv).isEmpty()) {
            for (Entry it : $receiver$iv) {
                if (containsEntry$kotlin_stdlib(it) == null) {
                    z = false;
                    break;
                }
            }
    ...
    private final Entry<K, V> implFindEntry(K key) {
        ...
        for (Object next : entrySet()) {
            if (Intrinsics.areEqual(((Entry) next).getKey(), (Object) key) != null) {
                break;
            }
        }
        Object next2 = null;
