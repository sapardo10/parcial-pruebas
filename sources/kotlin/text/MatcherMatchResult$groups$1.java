...
public final class MatcherMatchResult$groups$1 extends AbstractCollection<MatchGroup> implements MatchNamedGroupCollection {
    ...
    public MatchGroup get(int index) {
        IntRange range = this.this$0.matchResult;
        Intrinsics.checkExpressionValueIsNotNull(range, "matchResult");
        range = RegexKt.range(range, index);
    ...
    public MatchGroup get(@NotNull String name) {
        Intrinsics.checkParameterIsNotNull(name, PodDBAdapter.KEY_NAME);
