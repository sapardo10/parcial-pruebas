...
class SequencesKt___SequencesJvmKt extends SequencesKt__SequencesKt {
    ...
    public static final <R> Sequence<R> filterIsInstance(@NotNull Sequence<?> $receiver, @NotNull Class<R> klass) {
        ...
        Sequence<R> filter = SequencesKt___SequencesKt.filter($receiver, new SequencesKt___SequencesJvmKt$filterIsInstance$1(klass));
        if (filter != null) {
            return filter;
        }
    ...
    public static final <T extends Comparable<? super T>> SortedSet<T> toSortedSet(@NotNull Sequence<? extends T> $receiver) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
        return (SortedSet) SequencesKt___SequencesKt.toCollection($receiver, new TreeSet());
    }
    ...
    public static final <T> SortedSet<T> toSortedSet(@NotNull Sequence<? extends T> $receiver, @NotNull Comparator<? super T> comparator) {
        ...
        return (SortedSet) SequencesKt___SequencesKt.toCollection($receiver, new TreeSet(comparator));
    }
}
