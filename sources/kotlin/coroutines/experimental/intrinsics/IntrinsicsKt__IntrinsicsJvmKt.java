...
class IntrinsicsKt__IntrinsicsJvmKt {
    ...
    public static final <T> Continuation<Unit> createCoroutineUnchecked(@NotNull Function1<? super Continuation<? super T>, ? extends Object> $receiver, @NotNull Continuation<? super T> completion) {
        ...
        facade = CoroutineIntrinsics.interceptContinuationIfNeeded(completion.getContext(), new C1092x6df69f96(completion, $receiver, completion));
        return facade;
    }
    ...
    public static final <R, T> Continuation<Unit> createCoroutineUnchecked(@NotNull Function2<? super R, ? super Continuation<? super T>, ? extends Object> $receiver, R receiver, @NotNull Continuation<? super T> completion) {
        ...
        facade = CoroutineIntrinsics.interceptContinuationIfNeeded(completion.getContext(), new C1093x6df69f97(completion, $receiver, receiver, completion));
        return facade;
    }
    ...
    private static final <T> Continuation<Unit> buildContinuationByInvokeCall$IntrinsicsKt__IntrinsicsJvmKt(Continuation<? super T> completion, Function0<? extends Object> block) {
        return CoroutineIntrinsics.interceptContinuationIfNeeded(completion.getContext(), new C1091x502cf9f5(completion, block));
    }
