...
public final class CoroutinesKt {
    ...
    public static final <R, T> void startCoroutine(@NotNull Function2<? super R, ? super Continuation<? super T>, ? extends Object> $receiver, R receiver, @NotNull Continuation<? super T> completion) {
        ...
        IntrinsicsKt__IntrinsicsJvmKt.createCoroutineUnchecked($receiver, receiver, completion).resume(Unit.INSTANCE);
    }
    ...
    public static final <T> void startCoroutine(@NotNull Function1<? super Continuation<? super T>, ? extends Object> $receiver, @NotNull Continuation<? super T> completion) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(completion, "completion");
        IntrinsicsKt__IntrinsicsJvmKt.createCoroutineUnchecked($receiver, completion).resume(Unit.INSTANCE);
    }
    ...
    public static final <R, T> Continuation<Unit> createCoroutine(@NotNull Function2<? super R, ? super Continuation<? super T>, ? extends Object> $receiver, R receiver, @NotNull Continuation<? super T> completion) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(completion, "completion");
        return new SafeContinuation(IntrinsicsKt__IntrinsicsJvmKt.createCoroutineUnchecked($receiver, receiver, completion), IntrinsicsKt__IntrinsicsJvmKt.getCOROUTINE_SUSPENDED());
    }
    ...
    public static final <T> Continuation<Unit> createCoroutine(@NotNull Function1<? super Continuation<? super T>, ? extends Object> $receiver, @NotNull Continuation<? super T> completion) {
        Intrinsics.checkParameterIsNotNull($receiver, "$receiver");
        Intrinsics.checkParameterIsNotNull(completion, "completion");
        return new SafeContinuation(IntrinsicsKt__IntrinsicsJvmKt.createCoroutineUnchecked($receiver, completion), IntrinsicsKt__IntrinsicsJvmKt.getCOROUTINE_SUSPENDED());
    }

    @SinceKotlin(version = "1.1")
    private static final <T> Object suspendCoroutine(Function1<? super Continuation<? super T>, Unit> block, Continuation<? super T> c) {
        InlineMarker.mark(0);
        SafeContinuation safe = new SafeContinuation(CoroutineIntrinsics.normalizeContinuation(c));
        block.invoke(safe);
    ...
    private static final void processBareContinuationResume(Continuation<?> completion, Function0<? extends Object> block) {
        try {
            ...
            if (result != IntrinsicsKt__IntrinsicsJvmKt.getCOROUTINE_SUSPENDED()) {
                if (completion != null) {
