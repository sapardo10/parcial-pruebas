...
public final class KotlinVersion implements Comparable<KotlinVersion> {
    @NotNull
    @JvmField
    public static final KotlinVersion CURRENT = new KotlinVersion(1, 2, 61);
    ...
    private final int versionOf(int major, int minor, int patch) {
        ...
        stringBuilder2.append(major);
        stringBuilder2.append('.');
        stringBuilder2.append(minor);
        stringBuilder2.append('.');
    ...
    public boolean equals(@Nullable Object other) {
        ...
        KotlinVersion otherVersion = !(other instanceof KotlinVersion) ? null : other;
