...
public class IndeterminateProgressDrawable extends IndeterminateProgressDrawableBase {
    ...
    private void drawRing(Canvas canvas, Paint paint) {
        ...
        canvas2.drawArc(RECT_PROGRESS, ((this.mRingPathTransform.mTrimPathOffset + this.mRingPathTransform.mTrimPathStart) * 360.0f) - 0.049804688f, 360.0f * (this.mRingPathTransform.mTrimPathEnd - this.mRingPathTransform.mTrimPathStart), false, paint);
