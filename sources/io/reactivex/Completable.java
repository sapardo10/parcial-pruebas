...
public abstract class Completable implements CompletableSource {
    ...
    public final void blockingAwait() {
        CompletableObserver observer = new BlockingMultiObserver();
        subscribe(observer);
    ...
    public final Completable retry(BiPredicate<? super Integer, ? super Throwable> predicate) {
        return fromPublisher(toFlowable().retry((BiPredicate) predicate));
    }
    ...
    public final Disposable subscribe() {
        CompletableObserver observer = new EmptyCompletableObserver();
        subscribe(observer);
        return observer;
    }
    ...
    public final Disposable subscribe(Action onComplete, Consumer<? super Throwable> onError) {
        ObjectHelper.requireNonNull(onError, "onError is null");
        ObjectHelper.requireNonNull(onComplete, "onComplete is null");
        CompletableObserver observer = new CallbackCompletableObserver(onError, onComplete);
        subscribe(observer);
        return observer;
    }
    ...
    public final Disposable subscribe(Action onComplete) {
        ObjectHelper.requireNonNull(onComplete, "onComplete is null");
        CompletableObserver observer = new CallbackCompletableObserver(onComplete);
        subscribe(observer);
        return observer;
    }
    ...
    public final TestObserver<Void> test() {
        CompletableObserver to = new TestObserver();
        subscribe(to);
        return to;
    }
