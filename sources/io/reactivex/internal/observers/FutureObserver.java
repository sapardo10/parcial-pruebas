...
public final class FutureObserver<T> extends CountDownLatch implements Observer<T>, Future<T>, Disposable {
    ...
    L_0x0020:
        ...
        return r1;
        */
        throw new UnsupportedOperationException("Method not decompiled: io.reactivex.internal.observers.FutureObserver.cancel(boolean):boolean");
    }
    ...
    public void onError(Throwable t) {
        if (this.error == null) {
            this.error = t;
            while (true) {
                DisposableHelper a = (Disposable) this.upstream.get();
                if (a == this) {
                    break;
                } else if (a == DisposableHelper.DISPOSED) {
                    break;
