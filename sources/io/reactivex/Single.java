...
public abstract class Single<T> implements SingleSource<T> {
    ...
    public final Flowable<T> concatWith(SingleSource<? extends T> other) {
        return concat((SingleSource) this, (SingleSource) other);
    }
    ...
    public final T blockingGet() {
        SingleObserver observer = new BlockingMultiObserver();
        subscribe(observer);
    ...
    public final Single<T> retry(BiPredicate<? super Integer, ? super Throwable> predicate) {
        return toSingle(toFlowable().retry((BiPredicate) predicate));
    }
    ...
    public final Disposable subscribe(BiConsumer<? super T, ? super Throwable> onCallback) {
        ...
        SingleObserver observer = new BiConsumerSingleObserver(onCallback);
        subscribe(observer);
        return observer;
    }
    ...
    public final Disposable subscribe(Consumer<? super T> onSuccess, Consumer<? super Throwable> onError) {
        ObjectHelper.requireNonNull(onSuccess, "onSuccess is null");
        ObjectHelper.requireNonNull(onError, "onError is null");
        SingleObserver observer = new ConsumerSingleObserver(onSuccess, onError);
        subscribe(observer);
        return observer;
    }
    ...
    public final TestObserver<T> test() {
        SingleObserver to = new TestObserver();
        subscribe(to);
        return to;
    }
