    ...
    static final class Reader {
        ...
        private int evictToRecoverBytes(int bytesToRecover) {
            ...
            if (bytesToRecover > 0) {
                ...
                System.arraycopy(obj, i + 1, obj, (i + 1) + entriesToEvict, this.headerCount);
        ...
        private void insertIntoDynamicTable(int index, Header entry) {
            ...
            i = evictToRecoverBytes((this.dynamicTableByteCount + delta) - i);
            if (index == -1) {
                int i2 = this.headerCount + 1;
                Object obj = this.dynamicTable;
                if (i2 > obj.length) {
                    Header[] doubled = new Header[(obj.length * 2)];
                    System.arraycopy(obj, 0, doubled, obj.length, obj.length);
                    this.nextHeaderIndex = this.dynamicTable.length - 1;
                    this.dynamicTable = doubled;
                }
                i2 = this.nextHeaderIndex;
                this.nextHeaderIndex = i2 - 1;
                this.dynamicTable[i2] = entry;
                this.headerCount++;
            } else {
                this.dynamicTable[index + (dynamicTableIndex(index) + i)] = entry;
            }
    ...
    static final class Writer {
        ...
        private int evictToRecoverBytes(int bytesToRecover) {
            ...
            if (bytesToRecover > 0) {
                ...
                Arrays.fill(headerArr, i + 1, (i + 1) + entriesToEvict, null);
                this.nextHeaderIndex += entriesToEvict;
            }
            return entriesToEvict;
        }
