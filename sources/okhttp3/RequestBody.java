...
public abstract class RequestBody {
    ...
    class C00161 extends RequestBody {
        final /* synthetic */ ByteString val$content;
        final /* synthetic */ MediaType val$contentType;

        C00161(MediaType mediaType, ByteString byteString) {
    ...
    class C00172 extends RequestBody {
        final /* synthetic */ int val$byteCount;
        final /* synthetic */ byte[] val$content;
        final /* synthetic */ MediaType val$contentType;
        final /* synthetic */ int val$offset;

        C00172(MediaType mediaType, int i, byte[] bArr, int i2) {
            this.val$contentType = mediaType;
    ...
    class C00183 extends RequestBody {
        final /* synthetic */ MediaType val$contentType;
        final /* synthetic */ File val$file;

        C00183(MediaType mediaType, File file) {
            this.val$contentType = mediaType;
            this.val$file = file;
        }
    ...
    public static RequestBody create(@Nullable MediaType contentType, ByteString content) {
        return new C00161(contentType, content);
    }
    ...
    public static RequestBody create(@Nullable MediaType contentType, byte[] content, int offset, int byteCount) {
        if (content != null) {
            ...
            return new C00172(contentType, byteCount, content, offset);
        }
    ...
    public static RequestBody create(@Nullable MediaType contentType, File file) {
        if (file != null) {
            return new C00183(contentType, file);
        }
        throw new NullPointerException("content == null");
    }
}
